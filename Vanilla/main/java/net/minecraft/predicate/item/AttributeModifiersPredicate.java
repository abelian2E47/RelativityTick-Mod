...
public record AttributeModifiersPredicate(
    ...
    public static final Codec<AttributeModifiersPredicate> CODEC = RecordCodecBuilder.create(
        instance -> instance.group(
                CollectionPredicate.<AttributeModifiersComponent.Entry, AttributeModifiersPredicate.AttributeModifierPredicate>createCodec(
                        AttributeModifiersPredicate.AttributeModifierPredicate.CODEC
                    )
