            ...
            : EXCEPT_SPECTATOR.and(
                entityxx -> {
                    ...
                    if (!entity.getWorld().isClient || entityxx instanceof PlayerEntity && ((PlayerEntity)entityxx).isMainPlayer()) {
                        ...
                        AbstractTeam.CollisionRule collisionRule2 = abstractTeam2 == null
                        ...
                        return (collisionRule == AbstractTeam.CollisionRule.PUSH_OWN_TEAM || collisionRule2 == AbstractTeam.CollisionRule.PUSH_OWN_TEAM) && bl
                            ? false
                            : collisionRule != AbstractTeam.CollisionRule.PUSH_OTHER_TEAMS && collisionRule2 != AbstractTeam.CollisionRule.PUSH_OTHER_TEAMS
                                || bl;
                    } else {
                        return false;
                    }
