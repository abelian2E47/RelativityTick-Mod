    ...
    public void tick(WorldAccess world, BlockPos pos, Random random, boolean shouldConvertToBlock) {
        if (!this.cursors.isEmpty()) {
            ...
            for (Entry<BlockPos> entry : object2IntMap.object2IntEntrySet()) {
                ...
                SculkSpreadManager.Cursor cursor3 = map.get(blockPos2);
                ...
                if (i > 0 && collection != null) {
                    ...
                    world.syncWorldEvent(WorldEvents.SCULK_CHARGE, blockPos2, k);
                }
            }
