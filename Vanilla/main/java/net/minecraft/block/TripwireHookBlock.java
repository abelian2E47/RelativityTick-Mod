    ...
    public static void update(World world, BlockPos pos, BlockState state, boolean bl, boolean bl2, int i, @Nullable BlockState blockState) {
        ...
        if (optional.isPresent()) {
            ...
            if (j > 0) {
                ...
                Direction direction2 = direction.getOpposite();
                world.setBlockState(blockPos2, blockState3.with(FACING, direction2), Block.NOTIFY_ALL);
                updateNeighborsOnAxis(block, world, blockPos2, direction2);
                playSound(world, blockPos2, bl5, bl6, bl3, bl4);
            }
                ...
                for (int l = 1; l < j; l++) {
                    ...
                    if (blockState4 != null) {
                        ...
                        if (blockState5.isOf(Blocks.TRIPWIRE) || blockState5.isOf(Blocks.TRIPWIRE_HOOK)) {
                            world.setBlockState(blockPos3, blockState4.withIfExists(ATTACHED, bl5), Block.NOTIFY_ALL);
                        }
                    }
                }
            }
