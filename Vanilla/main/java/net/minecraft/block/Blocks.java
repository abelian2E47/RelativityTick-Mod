...
public class Blocks {
    ...
    public static final Block RAIL = register(
        "rail", RailBlock::new, AbstractBlock.Settings.create().noCollision().strength(0.7F).sounds(BlockSoundGroup.METAL)
    );
    ...
    public static final Block END_ROD = register(
        "end_rod",
        EndRodBlock::new,
        AbstractBlock.Settings.create().notSolid().breakInstantly().luminance(state -> 14).sounds(BlockSoundGroup.WOOD).nonOpaque()
    );
    ...
    public static final Block MOSSY_STONE_BRICK_SLAB = register(
        "mossy_stone_brick_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(MOSSY_STONE_BRICKS)
    );
    ...
    public static final Block ANCIENT_DEBRIS = register(
        "ancient_debris",
        AbstractBlock.Settings.create().mapColor(MapColor.BLACK).requiresTool().strength(30.0F, 1200.0F).sounds(BlockSoundGroup.ANCIENT_DEBRIS)
    );
    ...
    public static final Block WAXED_EXPOSED_COPPER_BULB = register(
        "waxed_exposed_copper_bulb", BulbBlock::new, AbstractBlock.Settings.copy(EXPOSED_COPPER_BULB)
    );
