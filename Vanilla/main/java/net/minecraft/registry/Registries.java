...
public class Registries {
    ...
    public static final Registry<HeightProviderType<?>> HEIGHT_PROVIDER_TYPE = create(
        RegistryKeys.HEIGHT_PROVIDER_TYPE, registry -> HeightProviderType.CONSTANT
    );
    ...
    public static final Registry<RecipeDisplay.Serializer<?>> RECIPE_DISPLAY = create(
        RegistryKeys.RECIPE_DISPLAY, RecipeDisplayBootstrap::registerAndGetDefault
    );
