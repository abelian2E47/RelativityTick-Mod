...
public class StrongholdGenerator {
    ...
    public static class FiveWayCrossing extends StrongholdGenerator.Piece {
        ...
        public void generate(
            ...
            this.fillWithOutline(
                world, chunkBox, 1, 3, 4, 3, 3, 4, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false
            );
            this.fillWithOutline(
                world, chunkBox, 1, 4, 6, 3, 4, 6, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false
            );
            this.fillWithOutline(world, chunkBox, 5, 1, 7, 7, 1, 8, false, random, StrongholdGenerator.STONE_BRICK_RANDOMIZER);
            this.fillWithOutline(
                world, chunkBox, 5, 1, 9, 7, 1, 9, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false
            );
            this.fillWithOutline(
                world, chunkBox, 5, 2, 7, 7, 2, 7, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false
            );
            this.fillWithOutline(
                world, chunkBox, 4, 5, 7, 4, 5, 9, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false
            );
            this.fillWithOutline(
                world, chunkBox, 8, 5, 7, 8, 5, 9, Blocks.SMOOTH_STONE_SLAB.getDefaultState(), Blocks.SMOOTH_STONE_SLAB.getDefaultState(), false
            );
            this.fillWithOutline(
                world,
                chunkBox,
    ...
    public static class Library extends StrongholdGenerator.Piece {
        ...
        public void generate(
            ...
            for (int l = 1; l <= 13; l++) {
                if ((l - 1) % 4 == 0) {
                    ...
                    if (this.tall) {
                        ...
                        this.fillWithOutline(
                            world, chunkBox, 12, 6, l, 12, 9, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false
                        );
                    }
                } else {
            ...
            for (int m = 3; m < 12; m += 2) {
                this.fillWithOutline(world, chunkBox, 3, 1, m, 4, 3, m, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                this.fillWithOutline(world, chunkBox, 6, 1, m, 7, 3, m, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                this.fillWithOutline(world, chunkBox, 9, 1, m, 10, 3, m, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
            }
            ...
            if (this.tall) {
                ...
                for (int n = 0; n <= 2; n++) {
                    this.addBlock(
                        world, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true).with(FenceBlock.WEST, true), 8 + n, 6, 12 - n, chunkBox
                    );
                    if (n != 2) {
                        this.addBlock(
                            world, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true).with(FenceBlock.EAST, true), 8 + n, 6, 11 - n, chunkBox
                        );
                    }
                }
    ...
    public static class PortalRoom extends StrongholdGenerator.Piece {
        ...
        public void generate(
            ...
            for (int k = 2; k < 9; k += 2) {
                this.fillWithOutline(world, chunkBox, k, 3, 15, k, 4, 15, blockState2, blockState2, false);
            }
            ...
            for (int l = 4; l <= 6; l++) {
                this.addBlock(world, blockState3, l, 1, 4, chunkBox);
                this.addBlock(world, blockState3, l, 2, 5, chunkBox);
                this.addBlock(world, blockState3, l, 3, 6, chunkBox);
            }
    ...
    public static class PrisonHall extends StrongholdGenerator.Piece {
        ...
        public void generate(
            ...
            for (int i = 1; i <= 3; i++) {
                ...
                this.addBlock(
                    world,
                    Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true).with(PaneBlock.SOUTH, true).with(PaneBlock.EAST, true),
                    4,
                    i,
                    5,
                    chunkBox
    ...
    public static class SquareRoom extends StrongholdGenerator.Piece {
        ...
        public void generate(
            ...
            switch (this.roomType) {
                ...
                case 2:
                    for (int j = 1; j <= 9; j++) {
                        this.addBlock(world, Blocks.COBBLESTONE.getDefaultState(), 1, 3, j, chunkBox);
                        this.addBlock(world, Blocks.COBBLESTONE.getDefaultState(), 9, 3, j, chunkBox);
                    }

                    for (int k = 1; k <= 9; k++) {
                        this.addBlock(world, Blocks.COBBLESTONE.getDefaultState(), k, 3, 1, chunkBox);
                        this.addBlock(world, Blocks.COBBLESTONE.getDefaultState(), k, 3, 9, chunkBox);
                    }
                    ...
                    for (int l = 1; l <= 3; l++) {
                        this.addBlock(world, Blocks.COBBLESTONE.getDefaultState(), 4, l, 4, chunkBox);
                        this.addBlock(world, Blocks.COBBLESTONE.getDefaultState(), 6, l, 4, chunkBox);
                        this.addBlock(world, Blocks.COBBLESTONE.getDefaultState(), 4, l, 6, chunkBox);
                        this.addBlock(world, Blocks.COBBLESTONE.getDefaultState(), 6, l, 6, chunkBox);
                    }

                    this.addBlock(world, Blocks.WALL_TORCH.getDefaultState(), 5, 3, 5, chunkBox);

                    for (int m = 2; m <= 8; m++) {
                        this.addBlock(world, Blocks.OAK_PLANKS.getDefaultState(), 2, 3, m, chunkBox);
                        this.addBlock(world, Blocks.OAK_PLANKS.getDefaultState(), 3, 3, m, chunkBox);
                        if (m <= 3 || m >= 7) {
                            this.addBlock(world, Blocks.OAK_PLANKS.getDefaultState(), 4, 3, m, chunkBox);
                            this.addBlock(world, Blocks.OAK_PLANKS.getDefaultState(), 5, 3, m, chunkBox);
                            this.addBlock(world, Blocks.OAK_PLANKS.getDefaultState(), 6, 3, m, chunkBox);
                        }

                        this.addBlock(world, Blocks.OAK_PLANKS.getDefaultState(), 7, 3, m, chunkBox);
                        this.addBlock(world, Blocks.OAK_PLANKS.getDefaultState(), 8, 3, m, chunkBox);
                    }
