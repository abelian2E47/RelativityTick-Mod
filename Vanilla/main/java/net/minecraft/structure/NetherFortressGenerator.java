...
public class NetherFortressGenerator {
    ...
    public static class BridgeCrossing extends NetherFortressGenerator.Piece {
        ...
        public void generate(
            ...
            for (int k = 0; k <= 2; k++) {
                for (int l = 7; l <= 11; l++) {
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), k, -1, l, chunkBox);
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), 18 - k, -1, l, chunkBox);
                }
            }
        }
    }
        ...
        public void generate(
            ...
            for (int i = 0; i <= 4; i++) {
                for (int j = 3; j <= 4; j++) {
                    ...
                    this.fillWithOutline(
                        world, chunkBox, i, j, 0, i, j, k, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
                    );
                }
            }

            int l = random2.nextInt(8);
            this.fillWithOutline(world, chunkBox, 0, 5, 0, 0, 5, l, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
            l = random2.nextInt(8);
            this.fillWithOutline(world, chunkBox, 4, 5, 0, 4, 5, l, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);

            for (int n = 0; n <= 4; n++) {
                int o = random2.nextInt(5);
                this.fillWithOutline(world, chunkBox, n, 2, 0, n, 2, o, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false);
            }
            ...
            for (int p = 0; p <= 4; p++) {
                for (int q = 0; q <= 1; q++) {
                    ...
                    this.fillWithOutline(
                        world, chunkBox, p, q, 0, p, q, r, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
                    );
                }
            }
        }
    ...
    public static class CorridorExit extends NetherFortressGenerator.Piece {
        ...
        public void generate(
            ...
            for (int j = 3; j <= 9; j += 2) {
                this.fillWithOutline(world, chunkBox, 1, 7, j, 1, 8, j, blockState2.with(FenceBlock.WEST, true), blockState2.with(FenceBlock.WEST, true), false);
                this.fillWithOutline(
                    world, chunkBox, 11, 7, j, 11, 8, j, blockState2.with(FenceBlock.EAST, true), blockState2.with(FenceBlock.EAST, true), false
                );
            }
            ...
            for (int k = 4; k <= 8; k++) {
                for (int l = 0; l <= 2; l++) {
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), k, -1, l, chunkBox);
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), k, -1, 12 - l, chunkBox);
                }
            }

            for (int m = 0; m <= 2; m++) {
                for (int n = 4; n <= 8; n++) {
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), m, -1, n, chunkBox);
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), 12 - m, -1, n, chunkBox);
                }
            }
    ...
    public static class CorridorNetherWartsRoom extends NetherFortressGenerator.Piece {
        ...
        public void generate(
            ...
            for (int j = 3; j <= 9; j += 2) {
                this.fillWithOutline(world, chunkBox, 1, 7, j, 1, 8, j, blockState3, blockState3, false);
                this.fillWithOutline(world, chunkBox, 11, 7, j, 11, 8, j, blockState4, blockState4, false);
            }
            ...
            for (int k = 0; k <= 6; k++) {
                ...
                for (int m = 5; m <= 7; m++) {
                    this.addBlock(world, blockState5, m, 5 + k, l, chunkBox);
                }

                if (l >= 5 && l <= 8) {
                    this.fillWithOutline(
                        world, chunkBox, 5, 5, l, 7, k + 4, l, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
                    );
                } else if (l >= 9 && l <= 10) {
                    this.fillWithOutline(
                        world, chunkBox, 5, 8, l, 7, k + 4, l, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
                    );
                }

                if (k >= 1) {
                    this.fillWithOutline(world, chunkBox, 5, 6 + k, l, 7, 9 + k, l, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
                }
            }

            for (int n = 5; n <= 7; n++) {
                this.addBlock(world, blockState5, n, 12, 11, chunkBox);
            }
            ...
            for (int o = 4; o <= 8; o++) {
                for (int p = 0; p <= 2; p++) {
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), o, -1, p, chunkBox);
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), o, -1, 12 - p, chunkBox);
                }
            }

            for (int q = 0; q <= 2; q++) {
                for (int r = 4; r <= 8; r++) {
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), q, -1, r, chunkBox);
                    this.fillDownwards(world, Blocks.NETHER_BRICKS.getDefaultState(), 12 - q, -1, r, chunkBox);
                }
            }
        }
    }
