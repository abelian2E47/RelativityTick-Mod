...
public class EndCityGenerator {
    ...
    static final EndCityGenerator.Part BUILDING = new EndCityGenerator.Part() {
        ...
        public boolean create(
            StructureTemplateManager manager, int depth, EndCityGenerator.Piece root, BlockPos pos, List<StructurePiece> pieces, Random random
        ) {
            if (depth > 8) {
                return false;
            }
    ...
    static final EndCityGenerator.Part SMALL_TOWER = new EndCityGenerator.Part() {
        ...
        public boolean create(
            ...
            for (int j = 0; j < i; j++) {
                piece = EndCityGenerator.addPiece(
                    pieces, EndCityGenerator.createPiece(manager, piece, new BlockPos(0, 4, 0), "tower_piece", blockRotation, true)
                );
            ...
            if (piece2 != null) {
                ...
                piece = EndCityGenerator.addPiece(
                    pieces, EndCityGenerator.createPiece(manager, piece, new BlockPos(-1, 4, -1), "tower_top", blockRotation, true)
                );
            } else {
                if (depth != 7) {
    ...
    static final EndCityGenerator.Part BRIDGE_PIECE = new EndCityGenerator.Part() {
        ...
        public boolean create(
            ...
            piece = EndCityGenerator.addPiece(
                pieces,
                EndCityGenerator.createPiece(manager, piece, new BlockPos(4, j, 0), "bridge_end", blockRotation.rotate(BlockRotation.CLOCKWISE_180), true)
            );
            piece.setChainLength(-1);
            return true;
        }
    ...
    static final EndCityGenerator.Part FAT_TOWER = new EndCityGenerator.Part() {
        ...
        public boolean create(
            ...
            piece = EndCityGenerator.addPiece(
                pieces, EndCityGenerator.createPiece(manager, piece, new BlockPos(0, 4, 0), "fat_tower_middle", blockRotation, true)
            );
            ...
            piece = EndCityGenerator.addPiece(
                pieces, EndCityGenerator.createPiece(manager, piece, new BlockPos(-2, 8, -2), "fat_tower_top", blockRotation, true)
            );
            return true;
        }
    };
