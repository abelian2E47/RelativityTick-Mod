    ...
    static class LayoutGenerator {
        ...
        public void generate(
            ...
            for (int m = 0; m < 3; m++) {
                ...
                WoodlandMansionGenerator.FlagMatrix flagMatrix3 = parameters.roomFlagsByFloor[m];
                ...
                for (int n = 0; n < flagMatrix4.m; n++) {
                    for (int o = 0; o < flagMatrix4.n; o++) {
                        if (flagMatrix4.get(o, n) == WoodlandMansionGenerator.MansionParameters.CORRIDOR) {
                            BlockPos blockPos2 = blockPos.offset(rotation.rotate(Direction.SOUTH), 8 + (n - this.entranceJ) * 8);
                            blockPos2 = blockPos2.offset(rotation.rotate(Direction.EAST), (o - this.entranceI) * 8);
                            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, "corridor_floor", blockPos2, rotation));
                            if (flagMatrix4.get(o, n - 1) == WoodlandMansionGenerator.MansionParameters.CORRIDOR
                                || (flagMatrix3.get(o, n - 1) & 8388608) == 8388608) {
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(
                                        this.manager, "carpet_north", blockPos2.offset(rotation.rotate(Direction.EAST), 1).up(), rotation
                                    )
                                );
                            }

                            if (flagMatrix4.get(o + 1, n) == WoodlandMansionGenerator.MansionParameters.CORRIDOR
                                || (flagMatrix3.get(o + 1, n) & 8388608) == 8388608) {
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(
                                        this.manager,
                                        "carpet_east",
                            ...
                            if (flagMatrix4.get(o, n + 1) == WoodlandMansionGenerator.MansionParameters.CORRIDOR
                                ...
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(
                                        this.manager,
                                        string,
                                        blockPos2.offset(rotation.rotate(Direction.SOUTH), 5).offset(rotation.rotate(Direction.WEST), 1),
                                        rotation
                                    )
                                );
                            }
                            ...
                            if (flagMatrix4.get(o - 1, n) == WoodlandMansionGenerator.MansionParameters.CORRIDOR
                                ...
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(
                                        this.manager,
                                        string2,
                                        blockPos2.offset(rotation.rotate(Direction.WEST), 1).offset(rotation.rotate(Direction.NORTH), 1),
                                        rotation
                                    )
                                );
                            }
                ...
                for (int p = 0; p < flagMatrix4.m; p++) {
                    for (int q = 0; q < flagMatrix4.n; q++) {
                        boolean bl2 = m == 2 && flagMatrix4.get(q, p) == WoodlandMansionGenerator.MansionParameters.STAIRCASE;
                        if (flagMatrix4.get(q, p) == WoodlandMansionGenerator.MansionParameters.ROOM || bl2) {
                            ...
                            if ((r & 2097152) == 2097152) {
                                for (Direction direction : Direction.Type.HORIZONTAL) {
                                    if (flagMatrix4.get(q + direction.getOffsetX(), p + direction.getOffsetZ())
                                        == WoodlandMansionGenerator.MansionParameters.CORRIDOR) {
                                        list.add(direction);
                                    }
                                }
                            }
                            ...
                            BlockPos blockPos3 = blockPos.offset(rotation.rotate(Direction.SOUTH), 8 + (p - this.entranceJ) * 8);
                            blockPos3 = blockPos3.offset(rotation.rotate(Direction.EAST), -1 + (q - this.entranceI) * 8);
                            if (WoodlandMansionGenerator.MansionParameters.isInsideMansion(flagMatrix4, q - 1, p)
                                && !parameters.isRoomId(flagMatrix4, q - 1, p, m, t)) {
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(this.manager, direction2 == Direction.WEST ? string4 : string3, blockPos3, rotation)
                                );
                            }

                            if (flagMatrix4.get(q + 1, p) == WoodlandMansionGenerator.MansionParameters.CORRIDOR && !bl2) {
                                BlockPos blockPos4 = blockPos3.offset(rotation.rotate(Direction.EAST), 8);
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(this.manager, direction2 == Direction.EAST ? string4 : string3, blockPos4, rotation)
                                );
                            }

                            if (WoodlandMansionGenerator.MansionParameters.isInsideMansion(flagMatrix4, q, p + 1)
                                && !parameters.isRoomId(flagMatrix4, q, p + 1, m, t)) {
                            ...
                            if (flagMatrix4.get(q, p - 1) == WoodlandMansionGenerator.MansionParameters.CORRIDOR && !bl2) {
                            ...
                            if (s == 65536) {
                                ...
                                Direction direction3 = parameters.findConnectedRoomDirection(flagMatrix4, q, p, m, t);
                                ...
                                if (!parameters.isRoomId(flagMatrix4, q + direction4.getOffsetX(), p + direction4.getOffsetZ(), m, t)) {
        ...
        private void addRoof(
            ...
            for (int i = 0; i < layout.m; i++) {
                for (int j = 0; j < layout.n; j++) {
                    ...
                    if (WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, j, i) && !bl) {
                        ...
                        if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, j - 1, i)) {
                            BlockPos blockPos3 = blockPos.offset(rotation.rotate(Direction.EAST), 0);
                            blockPos3 = blockPos3.offset(rotation.rotate(Direction.SOUTH), 7);
                            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, "roof_front", blockPos3, rotation.rotate(BlockRotation.CLOCKWISE_180)));
                        }

                        if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, j, i - 1)) {
                            BlockPos blockPos4 = blockPos.offset(rotation.rotate(Direction.WEST), 1);
                            pieces.add(
                                new WoodlandMansionGenerator.Piece(this.manager, "roof_front", blockPos4, rotation.rotate(BlockRotation.COUNTERCLOCKWISE_90))
                            );
                        }

                        if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, j, i + 1)) {
                            BlockPos blockPos5 = blockPos.offset(rotation.rotate(Direction.EAST), 6);
                            blockPos5 = blockPos5.offset(rotation.rotate(Direction.SOUTH), 6);
                            pieces.add(new WoodlandMansionGenerator.Piece(this.manager, "roof_front", blockPos5, rotation.rotate(BlockRotation.CLOCKWISE_90)));
                        }
                    }
                }
            }
            ...
            if (nextFloorLayout != null) {
                for (int k = 0; k < layout.m; k++) {
                    for (int l = 0; l < layout.n; l++) {
                        BlockPos blockPos6 = pos;
                        blockPos6 = blockPos6.offset(rotation.rotate(Direction.SOUTH), 8 + (k - this.entranceJ) * 8);
                        blockPos6 = blockPos6.offset(rotation.rotate(Direction.EAST), (l - this.entranceI) * 8);
                        boolean bl2 = WoodlandMansionGenerator.MansionParameters.isInsideMansion(nextFloorLayout, l, k);
                        if (WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l, k) && bl2) {
                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l + 1, k)) {
                                BlockPos blockPos7 = blockPos6.offset(rotation.rotate(Direction.EAST), 7);
                                pieces.add(new WoodlandMansionGenerator.Piece(this.manager, "small_wall", blockPos7, rotation));
                            }

                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l - 1, k)) {
                                BlockPos blockPos8 = blockPos6.offset(rotation.rotate(Direction.WEST), 1);
                                blockPos8 = blockPos8.offset(rotation.rotate(Direction.SOUTH), 6);
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(this.manager, "small_wall", blockPos8, rotation.rotate(BlockRotation.CLOCKWISE_180))
                                );
                            }

                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l, k - 1)) {
                                BlockPos blockPos9 = blockPos6.offset(rotation.rotate(Direction.WEST), 0);
                                blockPos9 = blockPos9.offset(rotation.rotate(Direction.NORTH), 1);
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(
                                        this.manager, "small_wall", blockPos9, rotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)
                                    )
                                );
                            }

                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l, k + 1)) {
                                BlockPos blockPos10 = blockPos6.offset(rotation.rotate(Direction.EAST), 6);
                                blockPos10 = blockPos10.offset(rotation.rotate(Direction.SOUTH), 7);
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(this.manager, "small_wall", blockPos10, rotation.rotate(BlockRotation.CLOCKWISE_90))
                                );
                            }

                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l + 1, k)) {
                                if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l, k - 1)) {
                                    BlockPos blockPos11 = blockPos6.offset(rotation.rotate(Direction.EAST), 7);
                                    blockPos11 = blockPos11.offset(rotation.rotate(Direction.NORTH), 2);
                                    pieces.add(new WoodlandMansionGenerator.Piece(this.manager, "small_wall_corner", blockPos11, rotation));
                                }

                                if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l, k + 1)) {
                                    BlockPos blockPos12 = blockPos6.offset(rotation.rotate(Direction.EAST), 8);
                                    blockPos12 = blockPos12.offset(rotation.rotate(Direction.SOUTH), 7);
                                    pieces.add(
                                        new WoodlandMansionGenerator.Piece(
                                            this.manager, "small_wall_corner", blockPos12, rotation.rotate(BlockRotation.CLOCKWISE_90)
                                        )
                                    );
                                }
                            }
                            ...
                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l - 1, k)) {
                                if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l, k - 1)) {
                                    BlockPos blockPos13 = blockPos6.offset(rotation.rotate(Direction.WEST), 2);
                                    blockPos13 = blockPos13.offset(rotation.rotate(Direction.NORTH), 1);
                                    pieces.add(
                                        new WoodlandMansionGenerator.Piece(
                                            this.manager, "small_wall_corner", blockPos13, rotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)
                                        )
                                    );
                                }

                                if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, l, k + 1)) {
                                    BlockPos blockPos14 = blockPos6.offset(rotation.rotate(Direction.WEST), 1);
                                    blockPos14 = blockPos14.offset(rotation.rotate(Direction.SOUTH), 8);
                                    pieces.add(
                                        new WoodlandMansionGenerator.Piece(
                                            this.manager, "small_wall_corner", blockPos14, rotation.rotate(BlockRotation.CLOCKWISE_180)
                                        )
                                    );
                                }
                            }
            ...
            for (int m = 0; m < layout.m; m++) {
                for (int n = 0; n < layout.n; n++) {
                    BlockPos blockPos15 = pos;
                    blockPos15 = blockPos15.offset(rotation.rotate(Direction.SOUTH), 8 + (m - this.entranceJ) * 8);
                    blockPos15 = blockPos15.offset(rotation.rotate(Direction.EAST), (n - this.entranceI) * 8);
                    boolean bl3 = nextFloorLayout != null && WoodlandMansionGenerator.MansionParameters.isInsideMansion(nextFloorLayout, n, m);
                    if (WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n, m) && !bl3) {
                        if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n + 1, m)) {
                            BlockPos blockPos16 = blockPos15.offset(rotation.rotate(Direction.EAST), 6);
                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n, m + 1)) {
                                BlockPos blockPos17 = blockPos16.offset(rotation.rotate(Direction.SOUTH), 6);
                                pieces.add(new WoodlandMansionGenerator.Piece(this.manager, "roof_corner", blockPos17, rotation));
                            } else if (WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n + 1, m + 1)) {
                                BlockPos blockPos18 = blockPos16.offset(rotation.rotate(Direction.SOUTH), 5);
                                pieces.add(new WoodlandMansionGenerator.Piece(this.manager, "roof_inner_corner", blockPos18, rotation));
                            }

                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n, m - 1)) {
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(
                                        this.manager, "roof_corner", blockPos16, rotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)
                                    )
                                );
                            } else if (WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n + 1, m - 1)) {
                                BlockPos blockPos19 = blockPos15.offset(rotation.rotate(Direction.EAST), 9);
                                blockPos19 = blockPos19.offset(rotation.rotate(Direction.NORTH), 2);
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(
                                        this.manager, "roof_inner_corner", blockPos19, rotation.rotate(BlockRotation.CLOCKWISE_90)
                                    )
                                );
                            }
                        }
                        ...
                        if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n - 1, m)) {
                            BlockPos blockPos20 = blockPos15.offset(rotation.rotate(Direction.EAST), 0);
                            blockPos20 = blockPos20.offset(rotation.rotate(Direction.SOUTH), 0);
                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n, m + 1)) {
                                BlockPos blockPos21 = blockPos20.offset(rotation.rotate(Direction.SOUTH), 6);
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(this.manager, "roof_corner", blockPos21, rotation.rotate(BlockRotation.CLOCKWISE_90))
                                );
                            } else if (WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n - 1, m + 1)) {
                                BlockPos blockPos22 = blockPos20.offset(rotation.rotate(Direction.SOUTH), 8);
                                blockPos22 = blockPos22.offset(rotation.rotate(Direction.WEST), 3);
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(
                                        this.manager, "roof_inner_corner", blockPos22, rotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)
                                    )
                                );
                            }
                            ...
                            if (!WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n, m - 1)) {
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(this.manager, "roof_corner", blockPos20, rotation.rotate(BlockRotation.CLOCKWISE_180))
                                );
                            } else if (WoodlandMansionGenerator.MansionParameters.isInsideMansion(layout, n - 1, m - 1)) {
                                BlockPos blockPos23 = blockPos20.offset(rotation.rotate(Direction.SOUTH), 1);
                                pieces.add(
                                    new WoodlandMansionGenerator.Piece(
                                        this.manager, "roof_inner_corner", blockPos23, rotation.rotate(BlockRotation.CLOCKWISE_180)
                                    )
                                );
                            }
                        }
        ...
        private void addMediumRoom(
            ...
            if (entranceDirection == Direction.EAST && connectedRoomDirection == Direction.SOUTH) {
                ...
                pieces.add(
                    new WoodlandMansionGenerator.Piece(
                        this.manager, pool.getMediumFunctionalRoom(this.random, staircase), blockPos2, rotation, BlockMirror.LEFT_RIGHT
                    )
                );
                ...
                pieces.add(
                    new WoodlandMansionGenerator.Piece(
                        this.manager, pool.getMediumFunctionalRoom(this.random, staircase), blockPos3, rotation.rotate(BlockRotation.CLOCKWISE_180)
                    )
                );
                ...
                pieces.add(
                    new WoodlandMansionGenerator.Piece(
                        this.manager, pool.getMediumFunctionalRoom(this.random, staircase), blockPos4, rotation, BlockMirror.FRONT_BACK
                    )
                );
                ...
                pieces.add(
                    new WoodlandMansionGenerator.Piece(
                        this.manager, pool.getMediumFunctionalRoom(this.random, staircase), blockPos6, rotation.rotate(BlockRotation.CLOCKWISE_90)
                    )
                );
                ...
                pieces.add(
                    new WoodlandMansionGenerator.Piece(
                        this.manager, pool.getMediumFunctionalRoom(this.random, staircase), blockPos8, rotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)
                    )
                );
                ...
                pieces.add(new WoodlandMansionGenerator.Piece(this.manager, pool.getMediumGenericRoom(this.random, staircase), blockPos9, rotation));
                ...
                pieces.add(
                    new WoodlandMansionGenerator.Piece(
                        this.manager, pool.getMediumGenericRoom(this.random, staircase), blockPos10, rotation.rotate(BlockRotation.CLOCKWISE_180)
                    )
                );
                ...
                pieces.add(
                    new WoodlandMansionGenerator.Piece(
                        this.manager, pool.getMediumGenericRoom(this.random, staircase), blockPos11, rotation.rotate(BlockRotation.CLOCKWISE_90)
                    )
                );
                ...
                pieces.add(
                    new WoodlandMansionGenerator.Piece(
                        this.manager, pool.getMediumGenericRoom(this.random, staircase), blockPos12, rotation.rotate(BlockRotation.COUNTERCLOCKWISE_90)
                    )
                );
                ...
                pieces.add(
                    new WoodlandMansionGenerator.Piece(
                        this.manager, pool.getMediumSecretRoom(this.random), blockPos13, rotation.rotate(BlockRotation.CLOCKWISE_90)
                    )
                );
                ...
                pieces.add(new WoodlandMansionGenerator.Piece(this.manager, pool.getMediumSecretRoom(this.random), blockPos14, rotation));
            }
        }
    ...
    static class MansionParameters {
        ...
        private void layoutCorridor(WoodlandMansionGenerator.FlagMatrix layout, int i, int j, Direction direction, int length) {
            if (length > 0) {
                ...
                layout.update(i + direction4.getOffsetX(), j + direction4.getOffsetZ(), UNSET, ROOM);
                layout.update(i + direction.getOffsetX() + direction3.getOffsetX(), j + direction.getOffsetZ() + direction3.getOffsetZ(), UNSET, ROOM);
                layout.update(i + direction.getOffsetX() + direction4.getOffsetX(), j + direction.getOffsetZ() + direction4.getOffsetZ(), UNSET, ROOM);
                ...
                layout.update(i + direction4.getOffsetX() * 2, j + direction4.getOffsetZ() * 2, UNSET, ROOM);
            }
        }
        ...
        private void layoutThirdFloor() {
            ...
            if (list.isEmpty()) {
                ...
                Direction direction = this.findConnectedRoomDirection(this.baseLayout, pair.getLeft(), pair.getRight(), 1, m & 65535);
                int n = pair.getLeft() + direction.getOffsetX();
                int o = pair.getRight() + direction.getOffsetZ();

                for (int p = 0; p < this.thirdFloorLayout.m; p++) {
                    for (int q = 0; q < this.thirdFloorLayout.n; q++) {
                        if (!isInsideMansion(this.baseLayout, q, p)) {
                            this.thirdFloorLayout.set(q, p, OUTSIDE);
                        } else if (q == pair.getLeft() && p == pair.getRight()) {
                            this.thirdFloorLayout.set(q, p, STAIRCASE);
                        } else if (q == n && p == o) {
                            this.thirdFloorLayout.set(q, p, STAIRCASE);
                            this.roomFlagsByFloor[2].set(q, p, 8388608);
                        }
                    }
                }
                ...
                for (Direction direction2 : Direction.Type.HORIZONTAL) {
                    if (this.thirdFloorLayout.get(n + direction2.getOffsetX(), o + direction2.getOffsetZ()) == 0) {
                ...
                if (list2.isEmpty()) {
                    ...
                    this.layoutCorridor(this.thirdFloorLayout, n + direction3.getOffsetX(), o + direction3.getOffsetZ(), direction3, 4);
            ...
            for (Pair<Integer, Integer> pair : objectArrayList) {
                ...
                if (roomFlags.get(l, m) == 0) {
                    ...
                    if (roomFlags.get(l + 1, m) == 0
                        ...
                        && layout.get(l + 1, m) == ROOM
                        && layout.get(l, m + 1) == ROOM
                        && layout.get(l + 1, m + 1) == ROOM) {
                        o++;
                        q++;
                        r = 262144;
                        ...
                        p--;
                        r = 262144;
                    } else if (roomFlags.get(l + 1, m) == 0 && layout.get(l + 1, m) == ROOM) {
                        o++;
                        r = 131072;
                    } else if (roomFlags.get(l, m + 1) == 0 && layout.get(l, m + 1) == ROOM) {
                        q++;
                        r = 131072;
                    } else if (roomFlags.get(l - 1, m) == 0 && layout.get(l - 1, m) == ROOM) {
                        n--;
                    ...
                    int u = 2097152;
                    if (!layout.anyMatchAround(s, t, CORRIDOR)) {
                        s = s == n ? o : n;
                        t = t == p ? q : p;
                        if (!layout.anyMatchAround(s, t, CORRIDOR)) {
                            t = t == p ? q : p;
