        ...
        if (this.adjustToAverageHeight(world, chunkBox, 0)) {
            ...
            for (int j = 0; j <= 11; j += 11) {
                for (int k = 2; k <= 12; k += 2) {
                    this.fillWithOutline(world, chunkBox, j, 4, k, j, 5, k, false, random, COBBLESTONE_RANDOMIZER);
                }

                this.fillWithOutline(world, chunkBox, j, 6, 5, j, 6, 5, false, random, COBBLESTONE_RANDOMIZER);
                this.fillWithOutline(world, chunkBox, j, 6, 9, j, 6, 9, false, random, COBBLESTONE_RANDOMIZER);
            }
            ...
            for (int l = 0; l < 4; l++) {
                this.addBlock(world, blockState3, 5, 0 - l, 6 + l, chunkBox);
                this.addBlock(world, blockState3, 6, 0 - l, 6 + l, chunkBox);
                this.fill(world, chunkBox, 5, 0 - l, 7 + l, 6, 0 - l, 9 + l);
            }
            ...
            for (int m = 1; m <= 13; m += 2) {
                this.fillWithOutline(world, chunkBox, 1, -3, m, 1, -2, m, false, random, COBBLESTONE_RANDOMIZER);
            }

            for (int n = 2; n <= 12; n += 2) {
                this.fillWithOutline(world, chunkBox, 1, -1, n, 3, -1, n, false, random, COBBLESTONE_RANDOMIZER);
            }
