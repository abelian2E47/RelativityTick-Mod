...
public interface StructureSets {
    static void bootstrap(Registerable<StructureSet> structureSetRegisterable) {
        ...
        structureSetRegisterable.register(
            ...
            new StructureSet(
                registryEntryLookup.getOrThrow(StructureKeys.DESERT_PYRAMID), new RandomSpreadStructurePlacement(32, 8, SpreadType.LINEAR, 14357617)
            )
        );
        structureSetRegisterable.register(
        ...
        structureSetRegisterable.register(
            ...
            new StructureSet(
                registryEntryLookup.getOrThrow(StructureKeys.JUNGLE_PYRAMID), new RandomSpreadStructurePlacement(32, 8, SpreadType.LINEAR, 14357619)
            )
        );
        structureSetRegisterable.register(
        ...
        structureSetRegisterable.register(
            ...
            new StructureSet(
                registryEntryLookup.getOrThrow(StructureKeys.END_CITY), new RandomSpreadStructurePlacement(20, 11, SpreadType.TRIANGULAR, 10387313)
            )
        );
        structureSetRegisterable.register(
        ...
        structureSetRegisterable.register(
            ...
            new StructureSet(
                registryEntryLookup.getOrThrow(StructureKeys.TRIAL_CHAMBERS), new RandomSpreadStructurePlacement(34, 12, SpreadType.LINEAR, 94251327)
            )
        );
    }
}
