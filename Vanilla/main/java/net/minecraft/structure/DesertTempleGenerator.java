...
public class DesertTempleGenerator extends ShiftableStructurePiece {
        ...
        if (this.adjustToMinHeight(world, -random.nextInt(3))) {
            ...
            for (int j = 0; j < this.width; j++) {
                for (int k = 0; k < this.depth; k++) {
                    int l = -5;
                    this.fillDownwards(world, Blocks.SANDSTONE.getDefaultState(), j, -5, k, chunkBox);
                }
            }
            ...
            this.fillWithOutline(
                world, chunkBox, this.width - 6, 1, 5, this.width - 5, 2, 16, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false
            );

            for (int m = 5; m <= 17; m += 2) {
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), 4, 1, m, chunkBox);
                this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), 4, 2, m, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), this.width - 5, 1, m, chunkBox);
                this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), this.width - 5, 2, m, chunkBox);
            }
            ...
            for (int n = 0; n <= this.width - 1; n += this.width - 1) {
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 2, 1, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 2, 2, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 2, 3, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 3, 1, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 3, 2, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 3, 3, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 4, 1, chunkBox);
                this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), n, 4, 2, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 4, 3, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 5, 1, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 5, 2, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 5, 3, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 6, 1, chunkBox);
                this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), n, 6, 2, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 6, 3, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 7, 1, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 7, 2, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 7, 3, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 8, 1, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 8, 2, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 8, 3, chunkBox);
            }

            for (int o = 2; o <= this.width - 3; o += this.width - 3 - 2) {
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 2, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 2, 0, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 2, 0, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 3, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 3, 0, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 3, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o - 1, 4, 0, chunkBox);
                this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 4, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o + 1, 4, 0, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 5, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 5, 0, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 5, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o - 1, 6, 0, chunkBox);
                this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 6, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o + 1, 6, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o - 1, 7, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 7, 0, chunkBox);
                this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o + 1, 7, 0, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 8, 0, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 8, 0, chunkBox);
                this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 8, 0, chunkBox);
            }
            ...
            for (Direction direction : Direction.Type.HORIZONTAL) {
                if (!this.hasPlacedChest[direction.getHorizontalQuarterTurns()]) {
                    ...
                    this.hasPlacedChest[direction.getHorizontalQuarterTurns()] = this.addChest(
                        world, chunkBox, random, 10 + p, -11, 10 + q, LootTables.DESERT_PYRAMID_CHEST
                    );
                }
            }
    ...
    private void addSandOrSandstone(StructureWorldAccess world, int x, int y, int z, BlockBox chunkBox) {
        if (world.getRandom().nextFloat() < 0.33F) {
            ...
            BlockState blockState2 = Blocks.SAND.getDefaultState();
            this.addBlock(world, blockState2, x, y, z, chunkBox);
        }
    }
    ...
    private void generateBasementRoof(StructureWorldAccess world, BlockBox chunkBox, int startX, int y, int startZ, int endX, int endZ) {
        ...
        int k = random.nextBetween(startX, endX);
        int l = random.nextBetween(startZ, endZ);
        this.basementMarkerPos = new BlockPos(this.applyXTransform(k, l), this.applyYTransform(y), this.applyZTransform(k, l));
    }
