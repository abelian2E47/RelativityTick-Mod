...
public class TrialChamberData {
    ...
    public static final List<StructurePoolAliasBinding> ALIAS_BINDINGS = ImmutableList.<StructurePoolAliasBinding>builder()
        ...
        .add(
            StructurePoolAliasBinding.random(
                ...
                DataPool.<String>builder().add(spawner("melee/zombie")).add(spawner("melee/husk")).add(spawner("melee/spider")).build()
            )
        )
        .add(
            StructurePoolAliasBinding.random(
    ...
    public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
        ...
        StructurePools.register(
            ...
            new StructurePool(
                registryEntry, List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/decor/disposal"), 1)), StructurePool.Projection.RIGID
            )
        );
        StructurePools.register(
            poolRegisterable,
        ...
        StructurePools.register(
            ...
            new StructurePool(
                registryEntry,
                List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/spawner/connectors/slow_ranged"), 1)),
                StructurePool.Projection.RIGID
            )
        );
        StructurePools.register(
        ...
        StructurePools.register(
            ...
            new StructurePool(
                registryEntry,
                List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/spawner/connectors/small_melee"), 1)),
                StructurePool.Projection.RIGID
            )
        );
        StructurePools.register(
