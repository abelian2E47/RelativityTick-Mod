                ...
                if (optional.isPresent()) {
                    ...
                    if (string.equals("minecraft:suspicious_stew")) {
                        return itemStackTyped.updateTyped(
                            opticFinder2, tagTyped -> tagTyped.update(DSL.remainderFinder(), StatusEffectFix::fixSuspiciousStewEffects)
                        );
                    }
                    ...
                    if (POTION_ITEM_IDS.contains(string)) {
                        return itemStackTyped.updateTyped(
                            ...
                            tagTyped -> tagTyped.update(
                                DSL.remainderFinder(), tagDynamic -> fixEffectList(tagDynamic, "CustomPotionEffects", "custom_potion_effects")
                            )
                        );
                    }
                }
