...
public class ChunkPalettedStorageFix extends DataFix {
                                ...
                                for (int k : entry.getValue()) {
                                    ...
                                    if ("minecraft:podzol".equals(ChunkPalettedStorageFix.getName(dynamic2))) {
                                        ...
                                        if ("minecraft:snow".equals(string2) || "minecraft:snow_layer".equals(string2)) {
                                            this.setBlock(k, ChunkPalettedStorageFix.Mapping.SNOWY_PODZOL_STATE);
                                        }
                                    }
                                }
                                break;
                                    ...
                                    if (dynamic4 != null) {
                                        ...
                                        this.setBlock(
                                            ...
                                            ChunkPalettedStorageFix.Mapping.NOTE_BLOCK_IDS_TO_STATES
                                                .getOrDefault(string4, ChunkPalettedStorageFix.Mapping.NOTE_BLOCK_IDS_TO_STATES.get("false0"))
                                        );
                                    }
                                }
                                break;
                                    ...
                                    if (dynamic5 != null) {
                                        ...
                                        if (o != 14 && o >= 0 && o < 16) {
                                            String string5 = ChunkPalettedStorageFix.getProperty(dynamic6, "facing")
                                                ...
                                                + o;
                                            if (ChunkPalettedStorageFix.Mapping.BED_IDS_TO_STATES.containsKey(string5)) {
                                                this.setBlock(n, ChunkPalettedStorageFix.Mapping.BED_IDS_TO_STATES.get(string5));
                                            }
                                        }
                                    }
                                }
                                    ...
                                    if (ChunkPalettedStorageFix.getName(dynamic12).endsWith("_door")) {
                                        ...
                                        if ("lower".equals(ChunkPalettedStorageFix.getProperty(dynamic13, "half"))) {
                                            ...
                                            if (string13.equals(ChunkPalettedStorageFix.getName(dynamic14))) {
                                                ...
                                                this.setBlock(
                                                    u,
                                                    ChunkPalettedStorageFix.Mapping.DOOR_IDS_TO_STATES
                                                        .get(string13 + string14 + "lower" + string16 + string15 + string17)
                                                );
                                                this.setBlock(
                                                    v,
                                                    ChunkPalettedStorageFix.Mapping.DOOR_IDS_TO_STATES
                                                        .get(string13 + string14 + "upper" + string16 + string15 + string17)
                                                );
                                            }
                                        }
                                    }
                                ...
                                for (int r : entry.getValue()) {
                                    ...
                                    if ("minecraft:carved_pumpkin".equals(ChunkPalettedStorageFix.getName(dynamic9))) {
                                        ...
                                        if ("minecraft:grass_block".equals(string7) || "minecraft:dirt".equals(string7)) {
                                            this.setBlock(r, ChunkPalettedStorageFix.Mapping.PUMPKIN_STATE);
                                        }
                                    }
                                }
                                break;
                                ...
                                for (int l : entry.getValue()) {
                                    ...
                                    if ("minecraft:mycelium".equals(ChunkPalettedStorageFix.getName(dynamic3))) {
                                        ...
                                        if ("minecraft:snow".equals(string3) || "minecraft:snow_layer".equals(string3)) {
                                            this.setBlock(l, ChunkPalettedStorageFix.Mapping.SNOWY_MYCELIUM_STATE);
                                        }
                                    }
                                }
                                break;
                                    ...
                                    if (dynamic10 != null) {
                                        ...
                                        this.setBlock(
                                            ...
                                            ChunkPalettedStorageFix.Mapping.PLANT_TO_FLOWER_POT_STATES
                                                .getOrDefault(string8, ChunkPalettedStorageFix.Mapping.PLANT_TO_FLOWER_POT_STATES.get("minecraft:air0"))
                                        );
                                    }
                                }
                                break;
                                    ...
                                    if (dynamic11 != null) {
                                        ...
                                        this.setBlock(
                                            ...
                                            ChunkPalettedStorageFix.Mapping.SKULL_IDS_TO_STATES
                                                .getOrDefault(string12, ChunkPalettedStorageFix.Mapping.SKULL_IDS_TO_STATES.get("0north"))
                                        );
                                    }
                                }
                                break;
                            case 175:
                                for (int w : entry.getValue()) {
                                    ...
                                    if ("upper".equals(ChunkPalettedStorageFix.getProperty(dynamic15, "half"))) {
                                        Dynamic<?> dynamic16 = this.getBlock(adjacentTo(w, ChunkPalettedStorageFix.Facing.DOWN));
                                        String string18 = ChunkPalettedStorageFix.getName(dynamic16);
                                        switch (string18) {
                                            case "minecraft:sunflower":
                                                this.setBlock(w, ChunkPalettedStorageFix.Mapping.UPPER_HALF_SUNFLOWER_STATE);
                                                break;
                                            case "minecraft:lilac":
                                                this.setBlock(w, ChunkPalettedStorageFix.Mapping.UPPER_HALF_LILAC_STATE);
                                                break;
                                            case "minecraft:tall_grass":
                                                this.setBlock(w, ChunkPalettedStorageFix.Mapping.UPPER_HALF_TALL_GRASS_STATE);
                                                break;
                                            case "minecraft:large_fern":
                                                this.setBlock(w, ChunkPalettedStorageFix.Mapping.UPPER_HALF_LARGE_FERN_STATE);
                                                break;
                                            case "minecraft:rose_bush":
                                                this.setBlock(w, ChunkPalettedStorageFix.Mapping.UPPER_HALF_ROSE_BUSH_STATE);
                                                break;
                                            case "minecraft:peony":
                                                this.setBlock(w, ChunkPalettedStorageFix.Mapping.UPPER_HALF_PEONY_STATE);
                                        }
                                    }
                                }
                                break;
                            ...
                            case 177:
                                for (int p : entry.getValue()) {
                                    ...
                                    if (dynamic7 != null) {
                                        ...
                                        if (q != 15 && q >= 0 && q < 16) {
                                            String string6 = ChunkPalettedStorageFix.getProperty(dynamic8, entry.getIntKey() == 176 ? "rotation" : "facing")
                                                + "_"
                                                + q;
                                            if (ChunkPalettedStorageFix.Mapping.BANNER_IDS_TO_STATES.containsKey(string6)) {
                                                this.setBlock(p, ChunkPalettedStorageFix.Mapping.BANNER_IDS_TO_STATES.get(string6));
                                            }
                                        }
                                    }
                                }
        ...
        public static int adjacentTo(int packedLocalPos, ChunkPalettedStorageFix.Facing direction) {
            return switch (direction.getAxis()) {
                ...
                case Y -> {
                    ...
                    yield j >= 0 && j <= 255 ? packedLocalPos & 0xFF | j << 8 : -1;
                }
                case Z -> {
                    int k = (packedLocalPos >> 4 & 15) + direction.getDirection().getOffset();
                    yield k >= 0 && k <= 15 ? packedLocalPos & -241 | k << 4 : -1;
                }
            };
        }
    ...
    static class Mapping {
        ...
        private static void bed(Map<String, Dynamic<?>> map, int id, String color) {
            map.put(
                "southfalsefoot" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "south", "occupied", "false", "part", "foot"))
            );
            map.put(
                "westfalsefoot" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "west", "occupied", "false", "part", "foot"))
            );
            map.put(
                "northfalsefoot" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "north", "occupied", "false", "part", "foot"))
            );
            map.put(
                "eastfalsefoot" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "east", "occupied", "false", "part", "foot"))
            );
            map.put(
                "southfalsehead" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "south", "occupied", "false", "part", "head"))
            );
            map.put(
                "westfalsehead" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "west", "occupied", "false", "part", "head"))
            );
            map.put(
                "northfalsehead" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "north", "occupied", "false", "part", "head"))
            );
            map.put(
                "eastfalsehead" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "east", "occupied", "false", "part", "head"))
            );
            map.put(
                "southtruehead" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "south", "occupied", "true", "part", "head"))
            );
            map.put("westtruehead" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "west", "occupied", "true", "part", "head")));
            map.put(
                "northtruehead" + id, FixUtil.createBlockState("minecraft:" + color + "_bed", Map.of("facing", "north", "occupied", "true", "part", "head"))
            );
