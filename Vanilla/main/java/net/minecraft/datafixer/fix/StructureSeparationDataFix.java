...
public class StructureSeparationDataFix extends DataFix {
        ...
        if (optional.equals(Optional.of("customized"))) {
            ...
            switch ((String)optional.get()) {
                ...
                case "buffet":
                    ...
                    dynamic = createGeneratorSettings(l, worldGenSettingsDynamic, dynamic5, dynamic9);
                    break;
                default:
                                        ...
                                        switch (string2) {
                                            ...
                                            case "separation":
                                                if ("oceanmonument".equals(string)) {
                                                    ...
                                                    map.put(
                                                        "minecraft:monument",
                                                        new StructureSeparationDataFix.Information(i, information.separation, information.salt)
                                                    );
                                                }
    ...
    private static void insertStructureSettings(Map<String, StructureSeparationDataFix.Information> map, String structureId, String spacingStr, int minSpacing) {
        StructureSeparationDataFix.Information information = map.getOrDefault(structureId, STRUCTURE_SPACING.get(structureId));
