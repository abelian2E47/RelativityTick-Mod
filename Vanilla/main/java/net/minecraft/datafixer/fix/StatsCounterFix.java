            ...
            if (string != null) {
                ...
                if (i < 0) {
                    ...
                    if ("stat.mineBlock".equals(string2)) {
                        ...
                        String string4 = RENAMED_ITEM_STATS.get(string2);
                        if (string4 != null) {
                            String string5 = old.substring(i + 1).replace('.', ':');
                            String string6 = getItem(string5);
                            String string7 = string6 == null ? string5 : string6;
                            return new StatsCounterFix.Stat(string4, string7);
                        } else {
                            String string8 = RENAMED_ENTITY_STATS.get(string2);
                            if (string8 != null) {
                                String string9 = old.substring(i + 1).replace('.', ':');
                                String string10 = RENAMED_ENTITIES.getOrDefault(string9, string9);
                                return new StatsCounterFix.Stat(string8, string10);
                            } else {
                                return null;
                            }
                        }
