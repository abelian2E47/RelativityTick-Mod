        ...
        return switch (blockEntityId) {
            ...
            case "minecraft:banner" -> {
                ...
                if (optional3.isPresent()) {
                    data.setComponent("minecraft:base_color", dynamic.createString(BannerPatternFormatFix.getColorFromInt(optional3.get().intValue())));
                }
                        ...
                        optional.get()
                            ...
                            .map(
                                predicatesDynamic -> DataFixUtils.orElse(
                                    predicatesDynamic.asString().map(string -> createBlockPredicateListDynamic((Dynamic<?>)predicatesDynamic, string)).result(),
                                    predicatesDynamic
                                )
                            )
                    )
