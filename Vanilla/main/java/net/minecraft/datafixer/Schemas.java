    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(
            BlockNameFix.create(
                ...
                replacing(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))
            )
        );
        ...
        builder.addFixer(
            new EntityVariantTypeFix(
                ...
                "minecraft:cat",
                "CatType",
                Util.make(new Int2ObjectOpenHashMap(), catVariants -> {
        ...
        builder.addFixer(
            new EntityVariantTypeFix(
                ...
                "minecraft:frog",
                "Variant",
                Util.make(new Int2ObjectOpenHashMap(), frogVariants -> {
        ...
        builder.addFixer(
            new RenameEnchantmentFix(schema200, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge"))
        );
