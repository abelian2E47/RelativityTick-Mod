...
public class KickCommand {
    private static final SimpleCommandExceptionType CANNOT_KICK_OWNER_EXCEPTION = new SimpleCommandExceptionType(
        Text.translatable("commands.kick.owner.failed")
    );
            ...
            CommandManager.literal("kick")
                ...
                .then(
                    CommandManager.argument("targets", EntityArgumentType.players())
                        .executes(
                            context -> execute(
                                context.getSource(), EntityArgumentType.getPlayers(context, "targets"), Text.translatable("multiplayer.disconnect.kicked")
                            )
                        )
                        .then(
