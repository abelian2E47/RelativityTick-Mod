...
public class ServerEntityManager<T extends EntityLike> implements AutoCloseable {
    ...
    class Listener implements EntityChangeListener {
            ...
            if (l != this.sectionPos) {
                ...
                if (!this.section.remove(this.entity)) {
                    ServerEntityManager.LOGGER
                        .warn("Entity {} wasn't found in section {} (moving to {})", this.entity, ChunkSectionPos.from(this.sectionPos), l);
                }
        ...
        public void remove(Entity.RemovalReason reason) {
            if (!this.section.remove(this.entity)) {
                ServerEntityManager.LOGGER
                    .warn("Entity {} wasn't found in section {} (destroying due to {})", this.entity, ChunkSectionPos.from(this.sectionPos), reason);
            }
