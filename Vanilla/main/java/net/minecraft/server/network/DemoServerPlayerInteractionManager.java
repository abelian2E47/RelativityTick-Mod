...
public class DemoServerPlayerInteractionManager extends ServerPlayerInteractionManager {
    ...
    public void update() {
        ...
        if (!this.sentHelp && this.tick > 20) {
            ...
            this.player
                .networkHandler
                .sendPacket(new GameStateChangeS2CPacket(GameStateChangeS2CPacket.DEMO_MESSAGE_SHOWN, GameStateChangeS2CPacket.DEMO_OPEN_SCREEN));
        }
        ...
        if (l % 24000L == 500L) {
            ...
            if (l == 100L) {
                ...
                this.player
                    .networkHandler
                    .sendPacket(new GameStateChangeS2CPacket(GameStateChangeS2CPacket.DEMO_MESSAGE_SHOWN, GameStateChangeS2CPacket.DEMO_JUMP_HELP));
            } else if (l == 250L) {
                this.player
                    .networkHandler
