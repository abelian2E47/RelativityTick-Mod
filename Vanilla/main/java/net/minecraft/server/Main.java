...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                SaveLoading.ServerConfig serverConfig = createServerConfig(serverPropertiesLoader.getPropertiesHandler(), dynamic5, bl, resourcePackManager);
                            ...
                            context -> {
                                ...
                                if (dynamic5 != null) {
                                    ParsedSaveProperties parsedSaveProperties = LevelStorage.parseSaveProperties(
                                        dynamic5, context.dataConfiguration(), registry, context.worldGenRegistryManager()
                                    );
                                    return new SaveLoading.LoadContext<>(
                                        parsedSaveProperties.properties(), parsedSaveProperties.dimensions().toDynamicRegistryManager()
                                    );
                                }
