            ...
            AnyOfLootCondition.builder(
                AllOfLootCondition.builder(
                    ...
                    AnyOfLootCondition.builder(
                        ...
                        EntityPropertiesLootCondition.builder(
                            LootContext.EntityTarget.THIS,
                            EntityPredicate.Builder.create().flags(EntityFlagsPredicate.Builder.create().onGround(false)).build()
                        )
                    )
                ),
                AllOfLootCondition.builder(
            ...
            Enchantment.builder(
                ...
                .addEffect(
                    ...
                    new PlaySoundEnchantmentEffect(
                        SoundEvents.PARTICLE_SOUL_ESCAPE, ConstantFloatProvider.create(0.6F), UniformFloatProvider.create(0.6F, 1.0F)
                    ),
                    AllOfLootCondition.builder(
            ...
            Enchantment.builder(
                ...
                .addEffect(
                    ...
                    EntityPropertiesLootCondition.builder(
                            LootContext.EntityTarget.THIS,
                            EntityPredicate.Builder.create()
                                .type(EntityTypePredicate.create(registryEntryLookup5, EntityTypeTags.SENSITIVE_TO_BANE_OF_ARTHROPODS))
                        )
