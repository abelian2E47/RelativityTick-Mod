...
public class MatrixUtil {
    ...
    private static void applyJacobiIteration(Matrix3f AtA, Matrix3f matrix3f, Quaternionf quaternionf, Quaternionf quaternionf2) {
        ...
        if (AtA.m02 * AtA.m02 + AtA.m20 * AtA.m20 > 1.0E-6F) {
            GivensPair givensPair2 = approximateGivensQuaternion(AtA.m00, 0.5F * (AtA.m02 + AtA.m20), AtA.m22).negateSin();
            Quaternionf quaternionf4 = givensPair2.setYRotation(quaternionf);
            quaternionf2.mul(quaternionf4);
            givensPair2.setRotationY(matrix3f);
            conjugate(AtA, matrix3f);
        }

        if (AtA.m12 * AtA.m12 + AtA.m21 * AtA.m21 > 1.0E-6F) {
            GivensPair givensPair3 = approximateGivensQuaternion(AtA.m11, 0.5F * (AtA.m12 + AtA.m21), AtA.m22);
            Quaternionf quaternionf5 = givensPair3.setXRotation(quaternionf);
            quaternionf2.mul(quaternionf5);
            givensPair3.setRotationX(matrix3f);
            conjugate(AtA, matrix3f);
        }
    }
