...
public class PackratParsing {
    public static <T, C, P> ArgumentParser<List<T>> createParser(PackratParsing.Callbacks<T, C, P> callbacks) {
        ...
        parsingRules.set(
            symbol6, Term.sequence(Term.symbol(symbol7), Term.optional(Term.sequence(Literals.character(','), Term.symbol(symbol6)))), results -> {
        ...
        parsingRules.set(
            symbol7, Term.sequence(Term.symbol(symbol8), Term.optional(Term.sequence(Literals.character('|'), Term.symbol(symbol7)))), results -> {
