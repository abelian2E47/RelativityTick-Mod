...
public class ItemStringReader {
    ...
    static final SimpleCommandExceptionType COMPONENT_EXPECTED_EXCEPTION = new SimpleCommandExceptionType(
    ...
    public ItemStringReader.ItemResult consume(StringReader reader) throws CommandSyntaxException {
        ...
        RegistryEntry<Item> registryEntry = Objects.requireNonNull(mutableObject.getValue(), "Parser gave no item");
        ...
        private void readComponents() throws CommandSyntaxException {
            ...
            while (this.reader.canRead() && this.reader.peek() != ']') {
                ...
                if (this.reader.canRead() && this.reader.peek() == '!') {
                    ...
                    ComponentType<?> componentType2 = readComponentType(this.reader);
                    if (!set.add(componentType2)) {
                        throw ItemStringReader.REPEATED_COMPONENT_EXCEPTION.create(componentType2);
                    }
                    ...
                    this.callbacks.setSuggestor(ItemStringReader.SUGGEST_DEFAULT);
                    this.reader.skipWhitespace();
                    this.readComponentValue(componentType2);
                    this.reader.skipWhitespace();
                }
