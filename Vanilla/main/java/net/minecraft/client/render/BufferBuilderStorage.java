...
public class BufferBuilderStorage {
    ...
    public BufferBuilderStorage(int maxBlockBuildersPoolSize) {
        ...
        SequencedMap<RenderLayer, BufferAllocator> sequencedMap = Util.make(new Object2ObjectLinkedOpenHashMap<>(), map -> {
            ...
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, TexturedRenderLayers.getShieldPatterns());
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, TexturedRenderLayers.getBeds());
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, TexturedRenderLayers.getShulkerBoxes());
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, TexturedRenderLayers.getSign());
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, TexturedRenderLayers.getHangingSign());
            map.put(TexturedRenderLayers.getChest(), new BufferAllocator(786432));
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, RenderLayer.getArmorEntityGlint());
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, RenderLayer.getGlint());
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, RenderLayer.getGlintTranslucent());
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, RenderLayer.getEntityGlint());
            assignBufferBuilder((Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)map, RenderLayer.getWaterMask());
        });
        ...
        SequencedMap<RenderLayer, BufferAllocator> sequencedMap2 = Util.make(
            ...
            object2ObjectLinkedOpenHashMap -> ModelBaker.BLOCK_DESTRUCTION_RENDER_LAYERS
                .forEach(
                    renderLayer -> assignBufferBuilder(
                        (Object2ObjectLinkedOpenHashMap<RenderLayer, BufferAllocator>)object2ObjectLinkedOpenHashMap, renderLayer
                    )
                )
        );
