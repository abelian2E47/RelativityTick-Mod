    ...
    private void drawBrain(
        ...
        if (bl) {
            for (String string2 : brain.possibleActivities()) {
                drawString(matrices, vertexConsumers, brain.pos(), i, string2, -16711936, 0.02F);
                i++;
            }
        }
        ...
        if (bl) {
            for (String string3 : brain.gossips()) {
                if (string3.startsWith(brain.name())) {
                    drawString(matrices, vertexConsumers, brain.pos(), i, string3, -1, 0.02F);
                } else {
                    drawString(matrices, vertexConsumers, brain.pos(), i, string3, -23296, 0.02F);
                }
        ...
        if (bl) {
            for (String string4 : Lists.reverse(brain.memories())) {
                drawString(matrices, vertexConsumers, brain.pos(), i, string4, -3355444, 0.02F);
                i++;
            }
        }
