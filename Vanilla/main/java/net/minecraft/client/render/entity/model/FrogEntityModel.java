...
public class FrogEntityModel extends EntityModel<FrogEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData5.addChild(
            ...
            ModelTransform.pivot(-1.5F, -3.0F, -6.5F)
        );
        modelPartData5.addChild(
            EntityModelPartNames.LEFT_EYE,
            ModelPartBuilder.create().uv(0, 5).cuboid(-1.5F, -1.0F, -1.5F, 3.0F, 2.0F, 3.0F),
            ModelTransform.pivot(2.5F, -3.0F, -6.5F)
        );
        ...
        ModelPartData modelPartData7 = modelPartData3.addChild(
            ...
            ModelTransform.pivot(4.0F, -1.0F, -6.5F)
        );
        modelPartData7.addChild(
            EntityModelPartNames.LEFT_HAND,
        ...
        modelPartData8.addChild(
            EntityModelPartNames.RIGHT_HAND,
        ...
        ModelPartData modelPartData9 = modelPartData2.addChild(
            ...
            ModelTransform.pivot(3.5F, -3.0F, 4.0F)
        );
