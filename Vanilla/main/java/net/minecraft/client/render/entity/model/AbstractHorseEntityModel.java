...
public abstract class AbstractHorseEntityModel<T extends LivingHorseEntityRenderState> extends EntityModel<T> {
    ...
    public static ModelData getModelData(Dilation dilation) {
        ...
        modelPartData3.addChild(
            "upper_mouth", ModelPartBuilder.create().uv(0, 25).cuboid(-2.0F, -11.0F, -7.0F, 4.0F, 5.0F, 5.0F, dilation), ModelTransform.NONE
        );
    ...
    public void setAngles(T livingHorseEntityRenderState) {
        ...
        for (ModelPart modelPart2 : this.straps) {
            modelPart2.visible = livingHorseEntityRenderState.hasPassengers && livingHorseEntityRenderState.saddled;
        }
