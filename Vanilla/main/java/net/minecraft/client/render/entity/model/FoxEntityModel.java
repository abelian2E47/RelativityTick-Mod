...
public class FoxEntityModel extends EntityModel<FoxEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData modelPartData2 = modelPartData.addChild(
            ...
            ModelTransform.pivot(-1.0F, 16.5F, -3.0F)
        );
        ...
        modelPartData2.addChild(
            EntityModelPartNames.LEFT_EAR, ModelPartBuilder.create().uv(15, 1).cuboid(3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), ModelTransform.NONE
        );
        modelPartData2.addChild(
            EntityModelPartNames.NOSE, ModelPartBuilder.create().uv(6, 18).cuboid(-1.0F, 2.01F, -8.0F, 4.0F, 2.0F, 3.0F), ModelTransform.NONE
        );
    ...
    public void setAngles(FoxEntityRenderState foxEntityRenderState) {
        ...
        if (foxEntityRenderState.inSneakingPose) {
            float j = MathHelper.cos(foxEntityRenderState.age) * 0.01F;
            this.body.yaw = j;
            this.rightHindLeg.roll = j;
            this.leftHindLeg.roll = j;
            this.rightFrontLeg.roll = j / 2.0F;
            this.leftFrontLeg.roll = j / 2.0F;
        }
