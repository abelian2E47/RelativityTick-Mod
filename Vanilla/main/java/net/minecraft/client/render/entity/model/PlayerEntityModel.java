...
public class PlayerEntityModel extends BipedEntityModel<PlayerEntityRenderState> {
    ...
    public static ModelData getTexturedModelData(Dilation dilation, boolean slim) {
        ...
        if (slim) {
            ...
            ModelPartData modelPartData5 = modelPartData.getChild(EntityModelPartNames.RIGHT_ARM);
        ...
        ModelPartData modelPartData7 = modelPartData.getChild(EntityModelPartNames.RIGHT_LEG);
        ...
        ModelPartData modelPartData8 = modelPartData.getChild(EntityModelPartNames.BODY);
