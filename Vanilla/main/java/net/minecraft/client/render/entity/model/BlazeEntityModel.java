...
public class BlazeEntityModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        for (int k = 4; k < 8; k++) {
            ...
            float m = 2.0F + MathHelper.cos(k * 2 * 0.25F);
        ...
        for (int o = 8; o < 12; o++) {
            ...
            float q = 11.0F + MathHelper.cos(o * 1.5F * 0.5F);
    ...
    public void setAngles(LivingEntityRenderState livingEntityRenderState) {
        ...
        for (int j = 4; j < 8; j++) {
            this.rods[j].pivotY = 2.0F + MathHelper.cos((j * 2 + livingEntityRenderState.age) * 0.25F);
        ...
        for (int k = 8; k < 12; k++) {
            this.rods[k].pivotY = 11.0F + MathHelper.cos((k * 1.5F + livingEntityRenderState.age) * 0.5F);
