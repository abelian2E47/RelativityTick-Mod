...
public class LlamaEntityModel extends EntityModel<LlamaEntityRenderState> {
    ...
    private static ModelData transformBaby(ModelData modelData) {
        ...
        float g = 0.7F;
        float h = 1.1F;
        UnaryOperator<ModelTransform> unaryOperator = modelTransform -> modelTransform.addPivot(0.0F, 21.0F, 3.52F)
        ...
        UnaryOperator<ModelTransform> unaryOperator3 = modelTransform -> modelTransform.addPivot(0.0F, 33.0F, 0.0F)
