...
public class DragonEntityModel extends EntityModel<EnderDragonEntityRenderState> {
    ...
    public DragonEntityModel(ModelPart modelPart) {
        ...
        for (int j = 0; j < this.tailParts.length; j++) {
            this.tailParts[j] = modelPart.getChild(tail(j));
        }
    ...
    public static TexturedModelData createTexturedModelData() {
        ...
        for (int j = 0; j < 12; j++) {
            modelPartData.addChild(tail(j), modelPartBuilder, ModelTransform.pivot(0.0F, 10.0F, 60.0F + j * 10.0F));
        }
        ...
        ModelPartData modelPartData9 = modelPartData3.addChild(
            ...
            ModelPartBuilder.create()
                .cuboid(EntityModelPartNames.BONE, -56.0F, -4.0F, -4.0F, 56, 8, 8, 112, 88)
    ...
    public void setAngles(EnderDragonEntityRenderState enderDragonEntityRenderState) {
        ...
        this.head.pitch = MathHelper.wrapDegrees(enderDragonEntityRenderState.getNeckPartPitchOffset(6, frame, frame3))
            * (float) (Math.PI / 180.0)
            * 1.5F
            * 5.0F;
