...
public class CreakingEntityModel extends EntityModel<CreakingEntityRenderState> {
    ...
    private static ModelData getModelData() {
        ...
        ModelPartData modelPartData3 = modelPartData2.addChild(
            EntityModelPartNames.UPPER_BODY, ModelPartBuilder.create(), ModelTransform.pivot(-1.0F, -19.0F, 0.0F)
        );
    ...
    public void setAngles(CreakingEntityRenderState creakingEntityRenderState) {
        ...
        if (creakingEntityRenderState.unrooted) {
            this.animateWalking(
                CreakingAnimations.WALKING, creakingEntityRenderState.limbFrequency, creakingEntityRenderState.limbAmplitudeMultiplier, 1.0F, 1.0F
            );
        }
