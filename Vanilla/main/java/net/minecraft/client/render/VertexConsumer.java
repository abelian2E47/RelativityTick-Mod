...
public interface VertexConsumer {
    ...
    default VertexConsumer light(int uv) {
        return this.light(
            uv & (LightmapTextureManager.MAX_BLOCK_LIGHT_COORDINATE | 65295), uv >> 16 & (LightmapTextureManager.MAX_BLOCK_LIGHT_COORDINATE | 65295)
        );
    }
    ...
    default void quad(
        ...
        try (MemoryStack memoryStack = MemoryStack.stackPush()) {
            ...
            for (int n = 0; n < k; n++) {
                ...
                int y = ColorHelper.getArgb(l, (int)s, (int)t, (int)u);
                int z = LightmapTextureManager.applyEmission(is[n], m);
                float ab = byteBuffer.getFloat(16);
                float bb = byteBuffer.getFloat(20);
                Vector3f vector3f2 = matrix4f.transformPosition(g, h, o, new Vector3f());
                this.vertex(vector3f2.x(), vector3f2.y(), vector3f2.z(), y, ab, bb, i, z, vector3f.x(), vector3f.y(), vector3f.z());
            }
        }
    }
