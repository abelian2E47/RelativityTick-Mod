...
public abstract class RenderPhase {
    ...
    protected static final RenderPhase.Transparency NO_TRANSPARENCY = new RenderPhase.Transparency(
    ...
    protected static final RenderPhase.Transparency OVERLAY_TRANSPARENCY = new RenderPhase.Transparency(
    ...
    protected static final RenderPhase.ShaderProgram PARTICLE = new RenderPhase.ShaderProgram(ShaderProgramKeys.PARTICLE);
    ...
    protected static final RenderPhase.Texture MIPMAP_BLOCK_ATLAS_TEXTURE = new RenderPhase.Texture(
        SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, TriState.FALSE, true
    );
    ...
    protected static final RenderPhase.Layering WORLD_BORDER_LAYERING = new RenderPhase.Layering("world_border_layering", () -> {
    ...
    protected static final RenderPhase.ColorLogic NO_COLOR_LOGIC = new RenderPhase.ColorLogic(
