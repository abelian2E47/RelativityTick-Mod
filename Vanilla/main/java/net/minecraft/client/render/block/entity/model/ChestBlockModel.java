...
public class ChestBlockModel extends Model {
    ...
    public static TexturedModelData getSingleTexturedModelData() {
        ...
        modelPartData.addChild(
            EntityModelPartNames.BOTTOM, ModelPartBuilder.create().uv(0, 19).cuboid(1.0F, 0.0F, 1.0F, 14.0F, 10.0F, 14.0F), ModelTransform.NONE
        );
    ...
    public static TexturedModelData getDoubleChestRightTexturedBlockData() {
        ...
        ModelPartData modelPartData = modelData.getRoot();
        modelPartData.addChild(
            EntityModelPartNames.BOTTOM, ModelPartBuilder.create().uv(0, 19).cuboid(1.0F, 0.0F, 1.0F, 15.0F, 10.0F, 14.0F), ModelTransform.NONE
        );
    ...
    public static TexturedModelData getDoubleChestLeftTexturedBlockData() {
        ...
        ModelPartData modelPartData = modelData.getRoot();
        modelPartData.addChild(
            EntityModelPartNames.BOTTOM, ModelPartBuilder.create().uv(0, 19).cuboid(0.0F, 0.0F, 1.0F, 15.0F, 10.0F, 14.0F), ModelTransform.NONE
        );
