...
public class Keyboard {
    ...
    public void onKey(long window, int key, int scancode, int action, int modifiers) {
        if (window == this.client.getWindow().getHandle()) {
            ...
            if (action != 0) {
                ...
                if (bl2) {
                    if (Screen.hasControlDown()
                        ...
                        && this.client.options.getNarratorHotkey().getValue()) {
            ...
            boolean bl4 = this.client.currentScreen == null;
            boolean bl5 = bl4 || this.client.currentScreen instanceof GameMenuScreen gameMenuScreen && !gameMenuScreen.shouldShowMenu();
            if (action == 0) {
                KeyBinding.setKeyPressed(key2, false);
                if (bl5 && key == GLFW.GLFW_KEY_F3) {
                ...
                if (bl5) {
                    ...
                    bl6 |= bl && this.processF3(key);
                    this.switchF3State |= bl6;
