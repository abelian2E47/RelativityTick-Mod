            ...
            return CompletableFuture.supplyAsync(
                () -> {
                    ...
                    try {
                        ...
                        Text text2 = this.getErrorText(minecraftClientException);
                        throw new CompletionException(new AbuseReportSender.AbuseReportException(text2, minecraftClientException));
                    }
                },
