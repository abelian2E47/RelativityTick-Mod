...
public class RealmsBrokenWorldScreen extends RealmsScreen {
                ...
                () -> {
                    ...
                    if (this.serverData.state == RealmsServer.State.CLOSED) {
                        this.client
                            .execute(
                                () -> this.client
                                    .setScreen(new RealmsLongRunningMcoTaskScreen(this, new OpenServerTask(this.serverData, this, true, this.client)))
                            );
                    } else {
                        try {
    ...
    private void drawSlotFrame(
        ...
        if (activeSlot) {
            ...
            context.drawTexture(
                RenderLayer::getGuiTextured, identifier, x + 3, y + 3, 0.0F, 0.0F, 74, 74, 74, 74, 74, 74, ColorHelper.fromFloats(1.0F, f, f, f)
            );
