    ...
    class InvitedObjectSelectionList extends ElementListWidget<RealmsPlayerScreen.InvitedObjectSelectionListEntry> {
        ...
        protected void renderHeader(DrawContext context, int x, int y) {
            ...
            context.drawTextWithShadow(
                ...
                text,
                x + this.getRowWidth() / 2 - RealmsPlayerScreen.this.textRenderer.getWidth(text) / 2,
                y,
                Colors.WHITE
            );
        }
    ...
    class InvitedObjectSelectionListEntry extends ElementListWidget.Entry<RealmsPlayerScreen.InvitedObjectSelectionListEntry> {
        ...
        public InvitedObjectSelectionListEntry(final PlayerInfo playerInfo) {
            ...
            this.uninviteButton = TextIconButtonWidget.builder(REMOVE_TOOLTIP_TEXT, button -> this.uninvite(i), false)
                ...
                .narration(supplier -> ScreenTexts.joinSentences(Text.translatable("mco.invited.player.narration", playerInfo.getName()), supplier.get()))
                .build();
        ...
        public void render(
            ...
            int l = y + entryHeight / 2 - 16;
            RealmsUtil.drawPlayerHead(context, x, l, 32, this.playerInfo.getUuid());
            int m = y + entryHeight / 2 - 9 / 2;
            context.drawTextWithShadow(RealmsPlayerScreen.this.textRenderer, this.playerInfo.getName(), x + 8 + 32, m, i);
            int n = y + entryHeight / 2 - 10;
            int o = x + entryWidth - this.uninviteButton.getWidth();
