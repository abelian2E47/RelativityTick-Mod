        ...
        switch (keyCode) {
            ...
            case 259:
                if (Screen.hasControlDown()) {
                    EditBox.Substring substring3 = this.getPreviousWordAtCursor();
                    this.delete(substring3.beginIndex - this.cursor);
                } else {
                    this.delete(-1);
                }
            ...
            case 261:
                if (Screen.hasControlDown()) {
                    EditBox.Substring substring4 = this.getNextWordAtCursor();
                    this.delete(substring4.beginIndex - this.cursor);
                } else {
                    this.delete(1);
                }
            ...
            case 262:
                if (Screen.hasControlDown()) {
                    EditBox.Substring substring2 = this.getNextWordAtCursor();
                    this.moveCursor(CursorMovement.ABSOLUTE, substring2.beginIndex);
                } else {
