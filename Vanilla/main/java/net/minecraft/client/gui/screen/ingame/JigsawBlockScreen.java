...
public class JigsawBlockScreen extends Screen {
    ...
    protected void init() {
        ...
        this.jointRotationButton = this.addDrawableChild(
            CyclingButtonWidget.builder(JigsawBlockEntity.Joint::asText)
        ...
        this.addDrawableChild(
            CyclingButtonWidget.onOffBuilder(this.keepJigsaws)
                .build(
                    this.width / 2 - 50, 185, 100, 20, Text.translatable("jigsaw_block.keep_jigsaws"), (button, keepJigsaws) -> this.keepJigsaws = keepJigsaws
                )
        );
