...
public class ExperimentalWarningScreen extends Screen {
    ...
    protected void init() {
        ...
        adder.add(
            ButtonWidget.builder(DETAILS, button -> this.client.setScreen(new ExperimentalWarningScreen.DetailsScreen())).width(100).build(), 2, positioner
        );
                    ...
                    if (!string.isEmpty()) {
                        ...
                        this.addEntry(
                            DetailsScreen.this.new PackListWidgetEntry(
                                text, text2, MultilineText.create(DetailsScreen.this.textRenderer, text2, this.getRowWidth())
                            )
                        );
                    }
                }
