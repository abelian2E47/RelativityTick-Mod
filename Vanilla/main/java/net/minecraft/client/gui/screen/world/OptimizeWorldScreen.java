    ...
    public static OptimizeWorldScreen create(
        ...
        try {
            ...
            try (SaveLoader saveLoader = integratedServerLoader.load(storageSession.readLevelProperties(), false, resourcePackManager)) {
                ...
                return new OptimizeWorldScreen(callback, dataFixer, storageSession, saveProperties.getLevelInfo(), eraseCache, immutable);
            }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (this.updater.getTotalChunkCount() > 0) {
            ...
            context.drawTextWithShadow(
                this.textRenderer, Text.translatable("optimizeWorld.info.converted", this.updater.getUpgradedChunkCount()), i, 40, 10526880
            );
            context.drawTextWithShadow(
                this.textRenderer, Text.translatable("optimizeWorld.info.skipped", this.updater.getSkippedChunkCount()), i, 40 + 9 + 3, 10526880
            );
            context.drawTextWithShadow(
