...
public class SocialInteractionsScreen extends Screen {
    ...
    protected void init() {
        ...
        this.blockedTabButton = this.addDrawableChild(
            ButtonWidget.builder(BLOCKED_TAB_TITLE, button -> this.setCurrentTab(SocialInteractionsScreen.Tab.BLOCKED))
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (!this.playerList.isEmpty()) {
            ...
            context.drawCenteredTextWithShadow(
                this.client.textRenderer, EMPTY_BLOCKED_TEXT, this.width / 2, (72 + this.getPlayerListBottom()) / 2, Colors.WHITE
            );
        }
