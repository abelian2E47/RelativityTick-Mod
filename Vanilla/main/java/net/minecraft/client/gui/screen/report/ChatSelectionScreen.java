...
public class ChatSelectionScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(
            ButtonWidget.builder(ScreenTexts.BACK, button -> this.close()).dimensions(this.width / 2 - 155, this.height - 32, 150, 20).build()
        );
    ...
    public class SelectionListWidget
        ...
        public class SenderEntry extends ChatSelectionScreen.SelectionListWidget.Entry {
            ...
            public void render(
                ...
                context.drawTextWithShadow(
                    ChatSelectionScreen.this.textRenderer, this.headingText, i + 12 + 4, k, this.fromReportedPlayer ? Colors.WHITE : -1593835521
                );
            }
        }
