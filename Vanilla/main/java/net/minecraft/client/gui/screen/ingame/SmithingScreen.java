    ...
    private void equipArmorStand(ItemStack stack) {
        if (this.armorStand != null) {
            ...
            if (!stack.isEmpty()) {
                ...
                EquipmentSlot equipmentSlot2 = equippableComponent != null ? equippableComponent.slot() : EquipmentSlot.OFFHAND;
                this.armorStand.equipStack(equipmentSlot2, stack.copy());
            }
        }
    }
