    ...
    public void render(DrawContext context) {
        ...
        if (this.enabled) {
            ...
            if (!this.audibleEntries.isEmpty()) {
                ...
                for (SubtitlesHud.SubtitleEntry subtitleEntry3 : this.audibleEntries) {
                    int k = 255;
                    Text text = subtitleEntry3.getText();
                    SubtitlesHud.SoundEntry soundEntry = subtitleEntry3.getNearestSound(vec3d);
                    if (soundEntry != null) {
                        ...
                        int p = MathHelper.floor(
                            MathHelper.clampedLerp(255.0F, 75.0F, (float)(Util.getMeasuringTimeMs() - soundEntry.time) / (float)(3000.0 * d))
                        );
