...
public class ShaderProgramKeys {
    ...
    public static final ShaderProgramKey RENDERTYPE_ENTITY_SOLID = register(
        "rendertype_entity_solid", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL
    );
    ...
    public static final ShaderProgramKey RENDERTYPE_ENTITY_DECAL = register(
        "rendertype_entity_decal", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL
    );
    ...
    public static final ShaderProgramKey RENDERTYPE_ENTITY_ALPHA = register(
        "rendertype_entity_alpha", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL
    );
    ...
    public static final ShaderProgramKey RENDERTYPE_ENERGY_SWIRL = register(
        "rendertype_energy_swirl", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL
    );
