    ...
    public record Conditions(Optional<LootContextPredicate> player, Optional<DamagePredicate> damage, Optional<LootContextPredicate> entity)
        ...
        public static AdvancementCriterion<PlayerHurtEntityCriterion.Conditions> create(DamagePredicate.Builder damage) {
            return Criteria.PLAYER_HURT_ENTITY
                .create(new PlayerHurtEntityCriterion.Conditions(Optional.empty(), Optional.of(damage.build()), Optional.empty()));
        }

        public static AdvancementCriterion<PlayerHurtEntityCriterion.Conditions> createEntity(Optional<EntityPredicate> entity) {
            return Criteria.PLAYER_HURT_ENTITY
                .create(
                    new PlayerHurtEntityCriterion.Conditions(Optional.empty(), Optional.empty(), EntityPredicate.contextPredicateFromEntityPredicate(entity))
                );
        }
