...
public class WorldChunk extends Chunk {
    ...
    public BlockState setBlockState(BlockPos pos, BlockState state, boolean moved) {
        ...
        if (state.hasBlockEntity()) {
            ...
            if (blockEntity != null && !blockEntity.supports(state)) {
                LOGGER.warn(
                    "Found mismatched block entity @ {}: type = {}, state = {}", pos, blockEntity.getType().getRegistryEntry().registryKey().getValue(), state
                );
                this.removeBlockEntity(pos);
                blockEntity = null;
            }
    ...
    public NbtCompound getPackedBlockEntityNbt(BlockPos pos, RegistryWrapper.WrapperLookup registries) {
        ...
        NbtCompound nbtCompound2 = this.blockEntityNbts.get(pos);
                ...
                .compute(
                    ...
                    (pos, ticker) -> {
                        ...
                        if (ticker != null) {
                            ...
                            WorldChunk.WrappedBlockEntityTickInvoker wrappedBlockEntityTickInvoker = new WorldChunk.WrappedBlockEntityTickInvoker(
