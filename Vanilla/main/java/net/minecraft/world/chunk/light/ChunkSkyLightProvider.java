                    ...
                    if (k > j) {
                        ...
                        if (n > j) {
                            ...
                            if (!this.shapesCoverFullCube(blockState, blockState2, direction)) {
                                ...
                                if (n > 1) {
                                    this.method_51566(
                                        m, ChunkLightProvider.class_8531.method_51574(n, isTrivialForLighting(blockState2), direction.getOpposite())
                                    );
                                }
                    ...
                    for (int s = 0; s < 16; s++) {
                        ...
                        if (t <= q) {
                            ...
                            for (int z = q; z >= Math.max(p, t); z--) {
                                ...
                                if (z == t || z < y) {
                                    long ab = BlockPos.asLong(k + s, z, m + r);
                                    this.method_51566(ab, ChunkLightProvider.class_8531.method_51578(z == t, z < u, z < v, z < w, z < x));
                                }
                            }
