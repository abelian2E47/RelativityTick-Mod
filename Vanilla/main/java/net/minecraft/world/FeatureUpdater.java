        ...
        if (persistentStateManager != null) {
            for (String string : this.oldNames) {
                ...
                for (String string2 : nbtCompound.getKeys()) {
                    ...
                    this.featureIdToChunkNbt.computeIfAbsent(string5, stringx -> new Long2ObjectOpenHashMap<>()).put(l, nbtCompound2);
                }

                String string6 = string + "_index";
                ChunkUpdateState chunkUpdateState = persistentStateManager.getOrCreate(ChunkUpdateState.getPersistentStateType(), string6);
