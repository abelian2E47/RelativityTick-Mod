...
public class WireOrientation {
    ...
    private static WireOrientation initializeValuesArray(WireOrientation prime, WireOrientation[] valuesOut) {
        ...
        for (Direction direction3 : Direction.values()) {
            ...
            if (direction3 == prime.front) {
                direction4 = prime.up.getOpposite();
            }

            if (direction3 == prime.front.getOpposite()) {
                direction4 = prime.up;
            }

            prime.siblingsByUp.put(direction3, initializeValuesArray(new WireOrientation(direction3, direction4, prime.sideBias), valuesOut));
        }
    ...
    protected static int ordinalFromComponents(Direction up, Direction front, WireOrientation.SideBias sideBias) {
        ...
        int k = i << 1 | front.getDirection().ordinal();
