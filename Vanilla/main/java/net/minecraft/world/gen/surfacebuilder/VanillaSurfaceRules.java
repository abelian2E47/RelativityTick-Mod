    ...
    public static MaterialRules.MaterialRule createDefaultRule(boolean surface, boolean bedrockRoof, boolean bedrockFloor) {
        ...
        MaterialRules.MaterialRule materialRule7 = MaterialRules.sequence(
            ...
            MaterialRules.condition(
                ...
                MaterialRules.sequence(
                    MaterialRules.condition(materialCondition13, STONE), materialRule5, MaterialRules.condition(materialCondition9, SNOW_BLOCK)
                )
            ),
        ...
        MaterialRules.MaterialRule materialRule8 = MaterialRules.sequence(
            ...
            MaterialRules.condition(
                MaterialRules.biome(BiomeKeys.SNOWY_SLOPES),
                MaterialRules.sequence(
                    MaterialRules.condition(materialCondition13, STONE), materialRule6, MaterialRules.condition(materialCondition9, SNOW_BLOCK)
                )
            ),
            MaterialRules.condition(
        ...
        MaterialRules.MaterialRule materialRule9 = MaterialRules.sequence(
            ...
            MaterialRules.condition(
                ...
                MaterialRules.sequence(
                    ...
                    MaterialRules.condition(
                        materialCondition15, MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH_RANGE_30, SANDSTONE)
                    )
                )
            ),
            MaterialRules.condition(
                            ...
                            MaterialRules.condition(
                                ...
                                MaterialRules.condition(
                                    ...
                                    MaterialRules.sequence(
                                        ...
                                        MaterialRules.condition(MaterialRules.not(materialCondition6), GRAVEL)
                                    )
                                )
                            )
                        )
