...
public class MaterialRules {
    ...
    record ConditionalBlockStateRule(MaterialRules.BooleanSupplier condition, MaterialRules.BlockStateRule followup) implements MaterialRules.BlockStateRule {
        ...
        public BlockState tryApply(int x, int y, int z) {
            return !this.condition.get() ? null : this.followup.tryApply(x, y, z);
        }
    }
    ...
    public interface MaterialRule extends Function<MaterialRules.MaterialRuleContext, MaterialRules.BlockStateRule> {
        Codec<MaterialRules.MaterialRule> CODEC = Registries.MATERIAL_RULE
            .getCodec()
        ...
        public MaterialRules.BooleanSupplier apply(final MaterialRules.MaterialRuleContext materialRuleContext) {
            ...
            class VerticalGradientPredicate extends MaterialRules.FullLazyAbstractPredicate {
                ...
                protected boolean test() {
                    ...
                    double d = MathHelper.map(i, i, j, 1.0, 0.0);
