...
public class DensityFunctions {
    ...
    public static RegistryEntry<? extends DensityFunction> bootstrap(Registerable<DensityFunction> densityFunctionRegisterable) {
        ...
        DensityFunction densityFunction = registerAndGetHolder(
            ...
            DensityFunctionTypes.flatCache(
                DensityFunctionTypes.cache2d(DensityFunctionTypes.shiftA(registryEntryLookup.getOrThrow(NoiseParametersKeys.OFFSET)))
            )
        );
        DensityFunction densityFunction2 = registerAndGetHolder(
            ...
            SHIFT_Z,
            DensityFunctionTypes.flatCache(
                DensityFunctionTypes.cache2d(DensityFunctionTypes.shiftB(registryEntryLookup.getOrThrow(NoiseParametersKeys.OFFSET)))
            )
        );
    ...
    protected static NoiseRouter createSurfaceNoiseRouter(
        ...
        DensityFunction densityFunction2 = DensityFunctionTypes.noise(
