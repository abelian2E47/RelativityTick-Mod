        ...
        for (RegistryEntry<Structure> registryEntry : structures) {
            ...
            if (structurePresence != StructurePresence.START_NOT_PRESENT) {
                ...
                if (structureStart != null
                    && structureStart.hasChildren()
                    && (!skipReferencedStructures || checkNotReferenced(structureAccessor, structureStart))) {
                        ...
                        for (RegistryEntry<Biome> registryEntry : set) {
                            ...
                            if (k < list3.size()) {
                                ...
                                registryEntryList.stream()
                                    ...
                                    .forEach(feature -> intSet.add(indexedFeatures.indexMapping().applyAsInt(feature)));
                            }
                        }
