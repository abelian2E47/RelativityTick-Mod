...
public class VegetationConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(
            ...
            createRandomPatchFeatureConfig(
                new WeightedBlockStateProvider(
                    DataPool.<BlockState>builder().add(Blocks.SHORT_GRASS.getDefaultState(), 1).add(Blocks.FERN.getDefaultState(), 4)
                ),
                32
            )
        );
            ...
            new SimpleRandomFeatureConfig(
                RegistryEntryList.of(
                    PlacedFeatures.createEntry(
                        Feature.RANDOM_PATCH,
                        ConfiguredFeatures.createRandomPatchFeatureConfig(
                            Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.LILAC))
                        )
                    ),
                    PlacedFeatures.createEntry(
                        Feature.RANDOM_PATCH,
                        ConfiguredFeatures.createRandomPatchFeatureConfig(
                            Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.ROSE_BUSH))
                        )
                    ),
                    PlacedFeatures.createEntry(
                        Feature.RANDOM_PATCH,
                        ConfiguredFeatures.createRandomPatchFeatureConfig(
                            Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.PEONY))
                        )
                    ),
                    PlacedFeatures.createEntry(
        ...
        ConfiguredFeatures.register(
            ...
            new RandomFeatureConfig(
                List.of(
                    new RandomFeatureEntry(registryEntry10, 0.05F),
                    new RandomFeatureEntry(registryEntry21, 0.15F),
                    new RandomFeatureEntry(registryEntry24, 0.7F)
                ),
