...
public class VegetationPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
        ...
        PlacedFeatures.register(
            featureRegisterable, TREES_WINDSWEPT_SAVANNA, registryEntry41, treeModifiers(PlacedFeatures.createCountExtraModifier(2, 0.1F, 1))
        );
        ...
        PlacedFeatures.register(
            featureRegisterable, TREES_WINDSWEPT_FOREST, registryEntry44, treeModifiers(PlacedFeatures.createCountExtraModifier(3, 0.1F, 1))
        );
