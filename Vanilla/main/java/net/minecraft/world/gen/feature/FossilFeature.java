...
public class FossilFeature extends Feature<FossilFeatureConfig> {
    ...
    public boolean generate(FeatureContext<FossilFeatureConfig> context) {
        ...
        int m = Math.max(j - 15 - random.nextInt(10), structureWorldAccess.getBottomY() + 10);
        BlockPos blockPos3 = structureTemplate.offsetByTransformedSize(blockPos2.withY(m), BlockMirror.NONE, blockRotation);
