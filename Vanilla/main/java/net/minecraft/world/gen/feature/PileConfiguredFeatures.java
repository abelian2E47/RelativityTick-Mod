...
public class PileConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ConfiguredFeatures.register(
            featureRegisterable, PILE_HAY, Feature.BLOCK_PILE, new BlockPileFeatureConfig(new PillarBlockStateProvider(Blocks.HAY_BLOCK))
        );
        ...
        ConfiguredFeatures.register(
            ...
            new BlockPileFeatureConfig(
                new WeightedBlockStateProvider(
                    DataPool.<BlockState>builder().add(Blocks.BLUE_ICE.getDefaultState(), 1).add(Blocks.PACKED_ICE.getDefaultState(), 5)
                )
            )
        );
        ConfiguredFeatures.register(
