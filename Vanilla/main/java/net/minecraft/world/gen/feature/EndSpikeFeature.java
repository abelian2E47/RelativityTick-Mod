    ...
    private void generateSpike(ServerWorldAccess world, Random random, EndSpikeFeatureConfig config, EndSpikeFeature.Spike spike) {
        ...
        if (endCrystalEntity != null) {
            ...
            endCrystalEntity.refreshPositionAndAngles(
                spike.getCenterX() + 0.5, spike.getHeight() + 1, spike.getCenterZ() + 0.5, random.nextFloat() * 360.0F, 0.0F
            );
            world.spawnEntity(endCrystalEntity);
            BlockPos blockPos2 = endCrystalEntity.getBlockPos();
            this.setBlockState(world, blockPos2.down(), Blocks.BEDROCK.getDefaultState());
            this.setBlockState(world, blockPos2, FireBlock.getState(world, blockPos2));
        }
    }
