    ...
    public static final MapCodec<RandomOffsetPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(
        instance -> instance.group(
                IntProvider.createValidatingCodec(-16, 16)
                    .fieldOf("xz_spread")
                    .forGetter(randomOffsetPlacementModifier -> randomOffsetPlacementModifier.spreadXz),
                IntProvider.createValidatingCodec(-16, 16)
                    .fieldOf("y_spread")
                    .forGetter(randomOffsetPlacementModifier -> randomOffsetPlacementModifier.spreadY)
            )
