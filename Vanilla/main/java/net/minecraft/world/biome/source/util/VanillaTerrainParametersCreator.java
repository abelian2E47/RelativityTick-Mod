...
public class VanillaTerrainParametersCreator {
    ...
    private static <C, I extends ToFloatFunction<C>> Spline<C, I> method_42054(
        ...
        if (bl) {
            ...
            Spline<C, I> spline4 = Spline.<C, I>builder(ridgesFolded, amplifier).add(-0.7F, spline).add(-0.15F, 1.37F).build();
            Spline<C, I> spline5 = Spline.<C, I>builder(ridgesFolded, amplifier).add(0.45F, spline).add(0.7F, 1.56F).build();
            builder.add(0.05F, spline5).add(0.4F, spline5).add(0.45F, spline4).add(0.55F, spline4).add(0.58F, f);
        }
    ...
    private static <C, I extends ToFloatFunction<C>> Spline<C, I> method_42050(I ridgesFolded, float f, boolean bl, ToFloatFunction<Float> amplifier) {
        ...
        if (-0.65F < l && l < 1.0F) {
            ...
            float u = method_42047(i, k, -1.0F, 1.0F);
            if (bl) {
                builder.add(-1.0F, Math.max(0.2F, i));
                builder.add(0.0F, MathHelper.lerp(0.5F, i, k), u);
            } else {
                builder.add(-1.0F, i, u);
            }

            builder.add(1.0F, k, u);
        }
