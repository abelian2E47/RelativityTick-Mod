...
public abstract class BuiltinBiomes {
    public static void bootstrap(Registerable<Biome> biomeRegisterable) {
        ...
        biomeRegisterable.register(
            BiomeKeys.SUNFLOWER_PLAINS, OverworldBiomeCreator.createPlains(registryEntryLookup, registryEntryLookup2, true, false, false)
        );
        ...
        biomeRegisterable.register(
            BiomeKeys.OLD_GROWTH_PINE_TAIGA, OverworldBiomeCreator.createOldGrowthTaiga(registryEntryLookup, registryEntryLookup2, false)
        );
        biomeRegisterable.register(
            BiomeKeys.OLD_GROWTH_SPRUCE_TAIGA, OverworldBiomeCreator.createOldGrowthTaiga(registryEntryLookup, registryEntryLookup2, true)
        );
