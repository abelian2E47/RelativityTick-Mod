...
public class PortalForcer {
    ...
    public Optional<BlockLocating.Rectangle> createPortal(BlockPos pos, Direction.Axis axis) {
            ...
            for (int q = -1; q < 2; q++) {
                for (int r = 0; r < 2; r++) {
                    for (int s = -1; s < 3; s++) {
                        ...
                        mutable.set(
                            blockPos, r * direction.getOffsetX() + q * direction2.getOffsetX(), s, r * direction.getOffsetZ() + q * direction2.getOffsetZ()
                        );
        ...
        for (int t = -1; t < 3; t++) {
            for (int u = -1; u < 4; u++) {
                if (t == -1 || t == 2 || u == -1 || u == 3) {
                    mutable.set(blockPos, t * direction.getOffsetX(), u, t * direction.getOffsetZ());
        ...
        for (int v = 0; v < 2; v++) {
            for (int w = 0; w < 3; w++) {
                mutable.set(blockPos, v * direction.getOffsetX(), w, v * direction.getOffsetZ());
