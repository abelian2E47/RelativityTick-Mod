...
public class AnvilScreenHandler extends ForgingScreenHandler {
    ...
    public void updateResult() {
        ...
        if (!itemStack.isEmpty() && EnchantmentHelper.canHaveEnchantments(itemStack)) {
            ...
            int w = i <= 0 ? 0 : (int)MathHelper.clamp(l + i, 0L, 2147483647L);
            this.levelCost.set(w);
            if (i <= 0) {
            ...
            if (!itemStack2.isEmpty()) {
                int x = itemStack2.getOrDefault(DataComponentTypes.REPAIR_COST, 0);
                if (x < itemStack3.getOrDefault(DataComponentTypes.REPAIR_COST, 0)) {
                    x = itemStack3.getOrDefault(DataComponentTypes.REPAIR_COST, 0);
                }
                ...
                itemStack2.set(DataComponentTypes.REPAIR_COST, x);
