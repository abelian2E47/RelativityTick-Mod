...
public class SlotRanges {
    private static final List<SlotRange> SLOT_RANGES = Util.make(new ArrayList<>(), list -> {
        ...
        int m = EquipmentSlot.LEGS.getOffsetEntitySlotId(100);
        int n = EquipmentSlot.FEET.getOffsetEntitySlotId(100);
        int o = EquipmentSlot.BODY.getOffsetEntitySlotId(105);
        createAndAdd(list, "armor.head", i);
        createAndAdd(list, "armor.chest", j);
        createAndAdd(list, "armor.legs", m);
        createAndAdd(list, "armor.feet", n);
        createAndAdd(list, "armor.body", o);
        createAndAdd(list, "armor.*", i, j, m, n, o);
