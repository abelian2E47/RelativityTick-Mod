...
public class MapDecorationTypes {
    ...
    public static final RegistryEntry<MapDecorationType> VILLAGE_SNOWY = register(
        "village_snowy", "snowy_village", true, MapColor.LIGHT_GRAY.color, false, true
    );
    public static final RegistryEntry<MapDecorationType> VILLAGE_TAIGA = register(
        "village_taiga", "taiga_village", true, MapColor.LIGHT_GRAY.color, false, true
    );
    public static final RegistryEntry<MapDecorationType> JUNGLE_TEMPLE = register(
