...
public interface Instruments {
    ...
    static void bootstrap(Registerable<Instrument> registry) {
        register(registry, PONDER_GOAT_HORN, SoundEvents.GOAT_HORN_SOUNDS.get(0), 7.0F, 256.0F);
        register(registry, SING_GOAT_HORN, SoundEvents.GOAT_HORN_SOUNDS.get(1), 7.0F, 256.0F);
        register(registry, SEEK_GOAT_HORN, SoundEvents.GOAT_HORN_SOUNDS.get(2), 7.0F, 256.0F);
        register(registry, FEEL_GOAT_HORN, SoundEvents.GOAT_HORN_SOUNDS.get(3), 7.0F, 256.0F);
        register(registry, ADMIRE_GOAT_HORN, SoundEvents.GOAT_HORN_SOUNDS.get(4), 7.0F, 256.0F);
        register(registry, CALL_GOAT_HORN, SoundEvents.GOAT_HORN_SOUNDS.get(5), 7.0F, 256.0F);
        register(registry, YEARN_GOAT_HORN, SoundEvents.GOAT_HORN_SOUNDS.get(6), 7.0F, 256.0F);
        register(registry, DREAM_GOAT_HORN, SoundEvents.GOAT_HORN_SOUNDS.get(7), 7.0F, 256.0F);
    }
