...
public class Items {
    ...
    public static final Item DEAD_BUBBLE_CORAL_FAN = register(
        ...
        (block, settings) -> new VerticallyAttachableBlockItem(block, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, settings)
    );
    ...
    public static final Item LEATHER_LEGGINGS = register(
        "leather_leggings", settings -> new ArmorItem(ArmorMaterials.LEATHER, EquipmentType.LEGGINGS, settings)
    );
    ...
    public static final Item CHAINMAIL_CHESTPLATE = register(
        ...
        settings -> new ArmorItem(ArmorMaterials.CHAIN, EquipmentType.CHESTPLATE, settings),
    ...
    public static final Item DIAMOND_LEGGINGS = register(
        "diamond_leggings", settings -> new ArmorItem(ArmorMaterials.DIAMOND, EquipmentType.LEGGINGS, settings)
    );
