...
public class ParticleTypes {
    ...
    public static final Codec<ParticleEffect> TYPE_CODEC = Registries.PARTICLE_TYPE
        .getCodec()
    ...
    private static <T extends ParticleEffect> ParticleType<T> register(
        ...
        final Function<ParticleType<T>, PacketCodec<? super RegistryByteBuf, T>> packetCodecGetter
    ) {
