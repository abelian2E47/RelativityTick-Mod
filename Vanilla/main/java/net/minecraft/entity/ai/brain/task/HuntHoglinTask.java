            ...
            context -> context.group(
                ...
                .apply(
                    ...
                    (nearestVisibleHuntableHoglin, angryAt, huntedRecently, nearestVisibleAdultPiglins) -> (world, entity, time) -> {
                        if (!entity.isBaby()
                            && !context.<List>getOptionalValue(nearestVisibleAdultPiglins)
                            ...
                            context.<List>getOptionalValue(nearestVisibleAdultPiglins).ifPresent(piglin -> piglin.forEach(PiglinBrain::rememberHunting));
                            return true;
                        } else {
                            return false;
                        }
