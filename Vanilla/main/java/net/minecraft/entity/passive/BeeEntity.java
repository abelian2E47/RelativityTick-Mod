                ...
                for (int i = 1; i <= 2; i++) {
                    ...
                    if (blockState.isIn(BlockTags.BEE_GROWABLES)) {
                        if (block instanceof CropBlock cropBlock) {
                            ...
                            if (k < 3) {
                                blockState2 = blockState.with(SweetBerryBushBlock.AGE, k + 1);
                            }
            ...
            if (BeeEntity.this.ticksUntilCanPollinate > 0) {
                ...
                if (optional.isPresent()) {
                    ...
                    BeeEntity.this.navigation
                        .startMovingTo(
                            BeeEntity.this.flowerPos.getX() + 0.5, BeeEntity.this.flowerPos.getY() + 0.5, BeeEntity.this.flowerPos.getZ() + 0.5, 1.2F
                        );
                    return true;
                } else {
