...
public class FoxEntity extends AnimalEntity implements VariantHolder<FoxEntity.Type> {
    ...
    private static final Predicate<Entity> NOTICEABLE_PLAYER_FILTER = entity -> !entity.isSneaky()
    ...
    protected void initGoals() {
        ...
        this.goalSelector
            .add(4, new FleeEntityGoal<>(this, WolfEntity.class, 8.0F, 1.6, 1.4, entity -> !((WolfEntity)entity).isTamed() && !this.isAggressive()));
                    ...
                    this.world
                        .spawnEntity(
                            new ExperienceOrbEntity(
                                this.world, this.animal.getX(), this.animal.getY(), this.animal.getZ(), this.animal.getRandom().nextInt(7) + 1
                            )
                        );
                }
            }
