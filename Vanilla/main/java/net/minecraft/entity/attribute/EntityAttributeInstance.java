...
public class EntityAttributeInstance {
    ...
    private double computeValue() {
        ...
        for (EntityAttributeModifier entityAttributeModifier3 : this.getModifiersByOperation(EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL)) {
            e *= 1.0 + entityAttributeModifier3.value();
        }
