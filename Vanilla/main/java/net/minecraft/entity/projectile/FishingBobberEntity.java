    ...
    private void tickFishingLogic(BlockPos pos) {
        ...
        if (this.hookCountdown > 0) {
            ...
            if (this.waitCountdown < 20) {
                n += (20 - this.waitCountdown) * 0.05F;
            } else if (this.waitCountdown < 40) {
                n += (40 - this.waitCountdown) * 0.02F;
            } else if (this.waitCountdown < 60) {
                n += (60 - this.waitCountdown) * 0.01F;
            }
            ...
            if (this.random.nextFloat() < n) {
                ...
                double q = this.getX() + MathHelper.sin(o) * p * 0.1;
                double r = MathHelper.floor(this.getY()) + 1.0F;
                double s = this.getZ() + MathHelper.cos(o) * p * 0.1;
                BlockState blockState2 = serverWorld.getBlockState(BlockPos.ofFloored(q, r - 1.0, s));
