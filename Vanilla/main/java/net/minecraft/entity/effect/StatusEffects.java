...
public class StatusEffects {
    ...
    public static final RegistryEntry<StatusEffect> JUMP_BOOST = register(
        ...
        new StatusEffect(StatusEffectCategory.BENEFICIAL, 16646020)
            .addAttributeModifier(
                EntityAttributes.SAFE_FALL_DISTANCE, Identifier.ofVanilla("effect.jump_boost"), 1.0, EntityAttributeModifier.Operation.ADD_VALUE
            )
    );
    ...
    public static final RegistryEntry<StatusEffect> RAID_OMEN = register(
        "raid_omen",
        new RaidOmenStatusEffect(StatusEffectCategory.NEUTRAL, 14565464, ParticleTypes.RAID_OMEN).applySound(SoundEvents.EVENT_MOB_EFFECT_RAID_OMEN)
    );
