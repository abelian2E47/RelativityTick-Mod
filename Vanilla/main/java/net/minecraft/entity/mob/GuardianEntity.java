...
public class GuardianEntity extends HostileEntity {
    ...
    static class FireBeamGoal extends Goal {
        ...
        public boolean shouldContinue() {
            return super.shouldContinue()
                && (this.elder || this.guardian.getTarget() != null && this.guardian.squaredDistanceTo(this.guardian.getTarget()) > 9.0);
        }
    ...
    static class GuardianTargetPredicate implements TargetPredicate.EntityPredicate {
        ...
        public boolean test(@Nullable LivingEntity target, ServerWorld world) {
            return (target instanceof PlayerEntity || target instanceof SquidEntity || target instanceof AxolotlEntity)
                && target.squaredDistanceTo(this.owner) > 9.0;
        }
    }
}
