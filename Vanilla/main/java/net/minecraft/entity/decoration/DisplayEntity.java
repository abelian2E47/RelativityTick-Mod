...
public abstract class DisplayEntity extends Entity {
    ...
    protected void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("billboard", NbtElement.STRING_TYPE)) {
            DisplayEntity.BillboardMode.CODEC
                ...
                .resultOrPartial(Util.addPrefix("Display entity", LOGGER::error))
                .ifPresent(pair -> this.setBillboardMode(pair.getFirst()));
        }
        ...
        if (nbt.contains("brightness", NbtElement.COMPOUND_TYPE)) {
            Brightness.CODEC
                ...
                .resultOrPartial(Util.addPrefix("Display entity", LOGGER::error))
                .ifPresent(pair -> this.setBrightness(pair.getFirst()));
        } else {
    ...
    public static class ItemDisplayEntity extends DisplayEntity {
        ...
        private static final TrackedData<ItemStack> ITEM = DataTracker.registerData(
            DisplayEntity.ItemDisplayEntity.class, TrackedDataHandlerRegistry.ITEM_STACK
        );
        ...
        protected void readCustomDataFromNbt(NbtCompound nbt) {
            ...
            if (nbt.contains("item_display", NbtElement.STRING_TYPE)) {
                ModelTransformationMode.CODEC
                    ...
                    .ifPresent(mode -> this.setTransformationMode(mode.getFirst()));
            }
        }
    ...
    public static class TextDisplayEntity extends DisplayEntity {
        ...
        private static final TrackedData<Integer> LINE_WIDTH = DataTracker.registerData(
            DisplayEntity.TextDisplayEntity.class, TrackedDataHandlerRegistry.INTEGER
        );
        private static final TrackedData<Integer> BACKGROUND = DataTracker.registerData(
            DisplayEntity.TextDisplayEntity.class, TrackedDataHandlerRegistry.INTEGER
        );
        ...
        public static DisplayEntity.TextDisplayEntity.TextAlignment getAlignment(byte flags) {
            if ((flags & LEFT_ALIGNMENT_FLAG) != 0) {
                ...
                return (flags & RIGHT_ALIGNMENT_FLAG) != 0
                    ? DisplayEntity.TextDisplayEntity.TextAlignment.RIGHT
