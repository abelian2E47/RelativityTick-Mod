...
public class BrewingRecipeRegistry {
    ...
    public ItemStack craft(ItemStack ingredient, ItemStack input) {
        ...
        for (BrewingRecipeRegistry.Recipe<Potion> recipe2 : this.potionRecipes) {
            if (recipe2.from.matches(optional.get()) && recipe2.ingredient.test(ingredient)) {
                return PotionContentsComponent.createStack(input.getItem(), recipe2.to);
            }
        }
