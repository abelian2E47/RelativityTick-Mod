...
public class VanillaAdventureTabAdvancementGenerator implements AdvancementTabGenerator {
    ...
    private static AdvancementCriterion<UsingItemCriterion.Conditions> createLookingAtEntityUsing(
        EntityPredicate.Builder lookingAt, ItemPredicate.Builder using
    ) {
    ...
    public void accept(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
        ...
        Advancement.Builder.create()
            ...
            .criterion(
                "struck_villager",
                ChanneledLightningCriterion.Conditions.create(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.VILLAGER))
            )
        ...
        Advancement.Builder.create()
            ...
            .criterion(
                ...
                FallAfterExplosionCriterion.Conditions.create(
                    ...
                    EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.WIND_CHARGE)
                )
            )
                                    ...
                                    EntityPredicate.Builder.create()
                                        ...
                                        .equipment(
                                            EntityEquipmentPredicate.Builder.create()
                                                .mainhand(ItemPredicate.Builder.create().items(registryEntryLookup2, Items.MACE))
                                        )
                                )
                        )
                )
            ...
            .map(
                facing -> {
                    ...
                    LootCondition.Builder builder3 = LocationCheckLootCondition.builder(
                        LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks(blockRegistry, block)),
        ...
        VanillaRecipeGenerator.streamSmithingTemplates()
            ...
            .forEach(
                template -> builder.criterion(
                    "armor_trimmed_" + template.getValue(), RecipeCraftedCriterion.Conditions.create((RegistryKey<Recipe<?>>)template)
                )
            );
        return builder;
    }
