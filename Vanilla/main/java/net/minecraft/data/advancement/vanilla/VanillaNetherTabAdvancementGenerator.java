        ...
        LootContextPredicate lootContextPredicate = LootContextPredicate.create(
                    ...
                    EntityPredicate.Builder.create()
                        .equipment(
                            EntityEquipmentPredicate.Builder.create()
                                .head(ItemPredicate.Builder.create().tag(registryEntryLookup2, ItemTags.PIGLIN_SAFE_ARMOR))
                        )
                )
                .invert()
                .build(),
            EntityPropertiesLootCondition.builder(
                    ...
                    EntityPredicate.Builder.create()
                        .equipment(
                            EntityEquipmentPredicate.Builder.create()
                                .chest(ItemPredicate.Builder.create().tag(registryEntryLookup2, ItemTags.PIGLIN_SAFE_ARMOR))
                        )
                )
                .invert()
                .build(),
            EntityPropertiesLootCondition.builder(
                    ...
                    EntityPredicate.Builder.create()
                        .equipment(
                            EntityEquipmentPredicate.Builder.create()
                                .legs(ItemPredicate.Builder.create().tag(registryEntryLookup2, ItemTags.PIGLIN_SAFE_ARMOR))
                        )
                )
                .invert()
                .build(),
            EntityPropertiesLootCondition.builder(
                    ...
                    EntityPredicate.Builder.create()
                        .equipment(
                            EntityEquipmentPredicate.Builder.create()
                                .feet(ItemPredicate.Builder.create().tag(registryEntryLookup2, ItemTags.PIGLIN_SAFE_ARMOR))
                        )
                )
                .invert()
                .build()
                    ...
                    Optional.of(
                        EntityPredicate.contextPredicateFromEntityPredicate(
                            EntityPredicate.Builder.create()
                                ...
                                .flags(EntityFlagsPredicate.Builder.create().isBaby(false))
                        )
                    )
                )
            )
