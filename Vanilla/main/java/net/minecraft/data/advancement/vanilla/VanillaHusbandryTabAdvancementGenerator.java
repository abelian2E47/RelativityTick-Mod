...
public class VanillaHusbandryTabAdvancementGenerator implements AdvancementTabGenerator {
    ...
    public void accept(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
        ...
        Advancement.Builder.create()
            ...
            .criterion(
                "kill_axolotl_target",
                EffectsChangedCriterion.Conditions.create(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.AXOLOTL))
            )
            .display(
        ...
        AdvancementEntry advancementEntry12 = Advancement.Builder.create()
            ...
            .criterion(
                ...
                ThrownItemPickedUpByEntityCriterion.Conditions.createThrownItemPickedUpByPlayer(
                    ...
                    Optional.empty(),
                    Optional.of(
                        EntityPredicate.contextPredicateFromEntityPredicate(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.ALLAY))
                    )
                )
            )
                ...
                PlayerInteractedWithEntityCriterion.Conditions.create(
                    ...
                    Optional.of(
                        EntityPredicate.contextPredicateFromEntityPredicate(
                            EntityPredicate.Builder.create()
                                .type(registryEntryLookup, EntityType.SNIFFER)
        ...
        Advancement.Builder.create()
            ...
            .criterion(
                ...
                PlayerInteractedWithEntityCriterion.Conditions.create(
                    ...
                    Optional.of(
                        EntityPredicate.contextPredicateFromEntityPredicate(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.WOLF))
                    )
                )
            )
