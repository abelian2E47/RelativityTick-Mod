            ...
            LootTable.builder()
                ...
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.GLOW_BERRIES).weight(15).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(3.0F, 6.0F)))
                        )
                        ...
                        .with(
                            ItemEntry.builder(Items.PUMPKIN_SEEDS).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 4.0F)))
                        )
                        .with(
                ...
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Blocks.POWERED_RAIL).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F)))
                        )
                        .with(
                            ItemEntry.builder(Blocks.DETECTOR_RAIL).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F)))
                        )
                        .with(
                            ItemEntry.builder(Blocks.ACTIVATOR_RAIL)
                                .weight(5)
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.GOLDEN_CARROT).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 10.0F)))
                        )
                        .with(
                            ItemEntry.builder(Items.BAKED_POTATO).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 10.0F)))
                        )
            ...
            LootTable.builder()
                ...
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.ROTTEN_FLESH).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 8.0F)))
                        )
            ...
            LootTable.builder()
                ...
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Blocks.OAK_PLANKS).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 12.0F)))
                        )
                        ...
                        .with(
                            ItemEntry.builder(Blocks.DARK_OAK_LOG).weight(3).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F)))
                        )
                        .with(
                            ItemEntry.builder(Blocks.MANGROVE_LOG).weight(3).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F)))
                        )
                )
        );
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Blocks.LIGHT_GRAY_WOOL)
                                .weight(2)
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(ItemEntry.builder(Items.POTATO).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 7.0F))))
                        .with(
                            ItemEntry.builder(Items.SWEET_BERRIES).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 7.0F)))
                        )
                        .with(ItemEntry.builder(Items.BREAD).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
                        .with(
                            ItemEntry.builder(Items.PUMPKIN_SEEDS).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 5.0F)))
                        )
                        .with(ItemEntry.builder(Items.PUMPKIN_PIE).weight(1))
                        .with(ItemEntry.builder(Items.EMERALD).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
                        .with(
                            ItemEntry.builder(Blocks.SPRUCE_SAPLING)
                                .weight(5)
                                .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 5.0F)))
                        )
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(ItemEntry.builder(Items.EMERALD).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F))))
                        .with(
                            ItemEntry.builder(Blocks.ACACIA_SAPLING)
                                .weight(10)
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.IRON_NUGGET).weight(40).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(9.0F, 18.0F)))
                        )
                        .with(ItemEntry.builder(Items.FLINT_AND_STEEL).weight(40))
                        .with(ItemEntry.builder(Items.FIRE_CHARGE).weight(40))
                        .with(ItemEntry.builder(Items.GOLDEN_APPLE).weight(15))
                        .with(
                            ItemEntry.builder(Items.GOLD_NUGGET).weight(15).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(4.0F, 24.0F)))
                        )
                        ...
                        .with(
                            ItemEntry.builder(Items.GOLDEN_CARROT).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(4.0F, 12.0F)))
                        )
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.GLOW_BERRIES).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 10.0F))).weight(2)
                        )
                        .with(
                            ItemEntry.builder(Items.ACACIA_PLANKS).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(3.0F, 6.0F))).weight(1)
                        )
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(ItemEntry.builder(Items.DIAMOND_BLOCK).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))).weight(1))
                        .with(
                            ItemEntry.builder(Items.EMERALD_BLOCK).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F))).weight(5)
                        )
                        .with(
                        ...
                        .with(
                            ItemEntry.builder(Items.AMETHYST_SHARD)
                                .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(8.0F, 20.0F)))
                                .weight(20)
                        )
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.BAMBOO_PLANKS)
                                .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(5.0F, 15.0F)))
                                .weight(10)
                        )
                        .with(
                            ItemEntry.builder(Items.BAKED_POTATO).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(6.0F, 10.0F))).weight(10)
                        )
                )
        );
        lootTableBiConsumer.accept(
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.BAMBOO_HANGING_SIGN)
                                .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 4.0F)))
                                .weight(2)
                        )
                        .with(
                            ItemEntry.builder(Items.BAMBOO_PLANKS).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(3.0F, 6.0F))).weight(2)
                        )
            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.GOLDEN_CARROT).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F)))
                        )
                        .with(
                            ItemEntry.builder(Items.BOOK)
                                .weight(2)
        ...
        return LootTable.builder()
            .pool(
                LootPool.builder()
                    ...
                    .with(
                        ItemEntry.builder(Items.ENCHANTED_GOLDEN_APPLE).weight(2).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)))
                    )
            )
            .pool(
                LootPool.builder()
            ...
            .pool(
                LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE).weight(1))
            );
    }
        ...
        return LootTable.builder()
            .pool(
                LootPool.builder()
                    ...
                    .with(
                        ItemEntry.builder(Items.SPECTRAL_ARROW).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(10.0F, 22.0F)))
                    )
            ...
            .pool(
                LootPool.builder()
                    .rolls(UniformLootNumberProvider.create(3.0F, 4.0F))
                    .with(
                        ItemEntry.builder(Blocks.GILDED_BLACKSTONE).weight(2).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 5.0F)))
                    )
        ...
        return LootTable.builder()
            .pool(
                LootPool.builder()
                    ...
                    .with(
                        ItemEntry.builder(Items.ENCHANTED_GOLDEN_APPLE)
                            .weight(1)
                            .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 2.0F)))
                    )
                    ...
                    .with(
                        ItemEntry.builder(Items.EXPERIENCE_BOTTLE).weight(3).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F)))
                    )
