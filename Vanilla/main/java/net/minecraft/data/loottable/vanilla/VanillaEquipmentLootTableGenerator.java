            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            LootTableEntry.builder(createEquipmentTableBuilder(Items.DIAMOND_HELMET, Items.DIAMOND_CHESTPLATE, armorTrim, impl3).build())
                                .weight(1)
                        )
                )
        );
                    ...
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.BOW)
                                .apply(
                                    new SetEnchantmentsLootFunction.Builder()
                                        .enchantment(impl3.getOrThrow(Enchantments.POWER), ConstantLootNumberProvider.create(1.0F))
                                )
                        )
                        .with(
                            ItemEntry.builder(Items.BOW)
                                .apply(
                                    new SetEnchantmentsLootFunction.Builder()
                                        .enchantment(impl3.getOrThrow(Enchantments.PUNCH), ConstantLootNumberProvider.create(1.0F))
                                )
                        )
                )
        );
                        ...
                        ItemEntry.builder(helmet)
                            ...
                            .apply(
                                new SetEnchantmentsLootFunction.Builder()
                                    ...
                                    .enchantment(
                                        enchantmentRegistryWrapper.getOrThrow(Enchantments.PROJECTILE_PROTECTION), ConstantLootNumberProvider.create(4.0F)
                                    )
