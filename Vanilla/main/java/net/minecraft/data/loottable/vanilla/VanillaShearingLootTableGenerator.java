                                    ...
                                    .conditionally(
                                        EntityPropertiesLootCondition.builder(
                                            ...
                                            EntityPredicate.Builder.create()
                                                .typeSpecific(EntitySubPredicateTypes.MOOSHROOM.createPredicate(MooshroomEntity.Type.RED))
                                        )
                                    ),
                                LootTableEntry.builder(LootTables.MOOSHROOM_BROWN_SHEARING)
                                    .conditionally(
                                        EntityPropertiesLootCondition.builder(
                                            LootContext.EntityTarget.THIS,
                                            EntityPredicate.Builder.create()
                                                .typeSpecific(EntitySubPredicateTypes.MOOSHROOM.createPredicate(MooshroomEntity.Type.BROWN))
                                        )
                                    )
                            )
                        )
