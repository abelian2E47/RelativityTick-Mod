            ...
            LootTable.builder()
                .pool(
                    LootPool.builder()
                        ...
                        .with(
                            ItemEntry.builder(Items.IRON_NUGGET).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(10.0F, 36.0F)))
                        )
                        ...
                        .with(
                            ItemEntry.builder(Items.CRYING_OBSIDIAN)
                                .weight(40)
                        ...
                        .with(
                            ItemEntry.builder(Items.NETHER_BRICK).weight(40).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 8.0F)))
                        )
                        .with(
                            ItemEntry.builder(Items.SPECTRAL_ARROW)
                                .weight(40)
